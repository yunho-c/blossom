...
//}
//ubo int UserUniforms 0:37:4928 {
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_2 32
//spec_const bool SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_3 33
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 34
//spec_const bool SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1 35
//spec_const bool SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_2 36
//spec_const bool SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_3 37
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 38
//spec_const bool SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1 39
//spec_const bool SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_2 40
//spec_const bool SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_3 41
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 42
//spec_const bool UseViewSpaceDepthVariant 43
//spec_const bool capsule_btn_refl_tex_1HasSwappedViews 44
//spec_const bool capsule_btn_refl_tex_2HasSwappedViews 45
//spec_const bool capsule_btn_refl_tex_3HasSwappedViews 46
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1 78
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2 79
//spec_const int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3 80
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 81
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1 82
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2 83
//spec_const int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3 84
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 85
//spec_const int capsule_btn_refl_tex_1Layout 86
//spec_const int capsule_btn_refl_tex_2Layout 87
//spec_const int capsule_btn_refl_tex_3Layout 88
...
constant int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1 [[function_constant(78)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_2 [[function_constant(79)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_3 [[function_constant(80)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1 [[function_constant(82)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_2 [[function_constant(83)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_3 [[function_constant(84)]];
...
constant int capsule_btn_refl_tex_1Layout [[function_constant(86)]];
...
constant int capsule_btn_refl_tex_2Layout [[function_constant(87)]];
...
constant int capsule_btn_refl_tex_3Layout [[function_constant(88)]];
...
int l9_11=l9_10;
VectorOut_N114=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_11]*float4(Output_N113,0.0)).xyz;
...
float3x3 param_6=(*sc_set0.UserUniforms).capsule_btn_refl_tex_2Transform;
...
float4 param_9=(*sc_set0.UserUniforms).capsule_btn_refl_tex_2UvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_2_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).capsule_btn_refl_tex_2BorderColor;
float param_12=0.0;
...
float l9_87=l9_79;
float4 l9_88=sc_set0.capsule_btn_refl_tex_2.sample(sc_set0.capsule_btn_refl_tex_2SmpSC,l9_86,bias(l9_87));
float4 l9_89=l9_88;
float4 l9_90=l9_89;
if (param_10)
{
...
float3x3 param_17=(*sc_set0.UserUniforms).capsule_btn_refl_tex_3Transform;
...
float4 param_20=(*sc_set0.UserUniforms).capsule_btn_refl_tex_3UvMinMax;
bool param_21=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_3_tmp)!=0);
float4 param_22=(*sc_set0.UserUniforms).capsule_btn_refl_tex_3BorderColor;
float param_23=0.0;
...
float l9_167=l9_159;
float4 l9_168=sc_set0.capsule_btn_refl_tex_3.sample(sc_set0.capsule_btn_refl_tex_3SmpSC,l9_166,bias(l9_167));
...
int l9_176=l9_175;
VectorOut_N44=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_176]*float4(Output_N43,0.0)).xyz;
...
float3x3 param_30=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1Transform;
...
float4 param_33=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1UvMinMax;
bool param_34=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_35=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1BorderColor;
float param_36=0.0;
...
float l9_252=l9_244;
float4 l9_253=sc_set0.capsule_btn_refl_tex_1.sample(sc_set0.capsule_btn_refl_tex_1SmpSC,l9_251,bias(l9_252));
...
float4 param_38=(*sc_set0.UserUniforms).Port_Value0_N016;
float param_39=(*sc_set0.UserUniforms).Port_Position1_N016;
float4 param_40=(*sc_set0.UserUniforms).Port_Value1_N016;
float param_41=(*sc_set0.UserUniforms).Port_Position2_N016;
float4 param_42=(*sc_set0.UserUniforms).Port_Value2_N016;
float param_43=(*sc_set0.UserUniforms).Port_Position3_N016;
float4 param_44=(*sc_set0.UserUniforms).Port_Value3_N016;
float4 param_45=(*sc_set0.UserUniforms).Port_Value4_N016;
...
Value_N16=param_46;
float Rim_N23=0.0;
float3 param_47=(*sc_set0.UserUniforms).Port_Normal_N023;
float param_48=(*sc_set0.UserUniforms).Port_Exponent_N023;
float param_49=(*sc_set0.UserUniforms).Port_Intensity_N023;
...
float3x3 param_56=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1Transform;
...
float4 param_59=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1UvMinMax;
bool param_60=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1_tmp)!=0);
float4 param_61=(*sc_set0.UserUniforms).capsule_btn_refl_tex_1BorderColor;
float param_62=0.0;
...
float l9_333=l9_325;
float4 l9_334=sc_set0.capsule_btn_refl_tex_1.sample(sc_set0.capsule_btn_refl_tex_1SmpSC,l9_332,bias(l9_333));
...
float param_64=(*sc_set0.UserUniforms).Port_Rotation_N035;
float2 param_65=(*sc_set0.UserUniforms).Port_Center_N035;
...
float param_68=(*sc_set0.UserUniforms).Port_Value0_N030;
float param_69=(*sc_set0.UserUniforms).Port_Position1_N030;
float param_70=(*sc_set0.UserUniforms).Port_Value1_N030;
float param_71=(*sc_set0.UserUniforms).Port_Position2_N030;
float param_72=(*sc_set0.UserUniforms).Port_Value2_N030;
float param_73=(*sc_set0.UserUniforms).Port_Position3_N030;
float param_74=(*sc_set0.UserUniforms).Port_Value3_N030;
float param_75=(*sc_set0.UserUniforms).Port_Value4_N030;
...
{
if (param_77<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
...
bool l9_343=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_343)
{
...
if (sc_ShaderCacheConstant_tmp!=0)
{
param_79.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
...
float l9_348=l9_347;
float l9_349=l9_348;
float l9_350=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_349;
float3 l9_351=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_345.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_357.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float2 l9_360=l9_359.xy*(*sc_set0.UserUniforms).sc_CurrentRenderTargetDims.zw;
...
float l9_397=l9_389;
float4 l9_398=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_396,bias(l9_397));
...
float3 l9_408=definedBlend(l9_406,l9_407,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_416=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_416=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_81,param_82,in.varStereoViewID,(*sc_set0.UserUniforms));
float4 param_83=FinalColor;
float4 l9_418=param_83;
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_418.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
