...
vec3 l9_61=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_58*l9_60,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
float l9_62=l9_61.x;
sc_SoftwareWrapEarly(l9_62,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_63=l9_62;
float l9_64=l9_61.y;
sc_SoftwareWrapEarly(l9_64,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_65=l9_64;
vec2 l9_66;
float l9_67;
...
{
l9_68=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
l9_68=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_69=l9_63;
float l9_70=1.0;
sc_ClampUV(l9_69,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_68,l9_70);
float l9_71=l9_69;
float l9_72=l9_70;
bool l9_73;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_73=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
...
float l9_74=l9_65;
float l9_75=l9_72;
sc_ClampUV(l9_74,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_73,l9_75);
l9_67=l9_75;
...
#endif
vec2 l9_76=sc_TransformUV(l9_66,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_77=l9_76.x;
float l9_78=l9_67;
sc_SoftwareWrapLate(l9_77,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_78);
float l9_79=l9_76.y;
float l9_80=l9_78;
sc_SoftwareWrapLate(l9_79,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_80);
float l9_81=l9_80;
vec3 l9_82=sc_SamplingCoordsViewToGlobal(vec2(l9_77,l9_79),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_83=texture2D(capsule_btn_refl_tex_1,l9_82.xy,0.0);
vec4 l9_84;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_84=mix(capsule_btn_refl_tex_1BorderColor,l9_83,vec4(l9_81));
}
#else
{
l9_84=l9_83;
...
#endif
vec4 l9_85=vec4(Port_Import_N027)*l9_84;
float l9_86=clamp(l9_85.x,0.0,1.0);
vec4 l9_87;
if (l9_86<Port_Position1_N016)
{
l9_87=mix(Port_Value0_N016,Port_Value1_N016,vec4(clamp(l9_86/Port_Position1_N016,0.0,1.0)));
}
else
{
vec4 l9_88;
if (l9_86<Port_Position2_N016)
{
l9_88=mix(Port_Value1_N016,Port_Value2_N016,vec4(clamp((l9_86-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0)));
}
else
{
vec4 l9_89;
if (l9_86<Port_Position3_N016)
{
l9_89=mix(Port_Value2_N016,Port_Value3_N016,vec4(clamp((l9_86-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0)));
}
else
{
l9_89=mix(Port_Value3_N016,Port_Value4_N016,vec4(clamp((l9_86-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0)));
}
l9_88=l9_89;
}
l9_87=l9_88;
}
vec2 l9_90=((varPackedTex.xy-Port_Center_N019)*Port_Scale_N019)+Port_Center_N019;
float l9_91=l9_90.x;
sc_SoftwareWrapEarly(l9_91,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_92=l9_91;
float l9_93=l9_90.y;
sc_SoftwareWrapEarly(l9_93,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_94=l9_93;
vec2 l9_95;
float l9_96;
#if (SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)
...
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_97=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
l9_97=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_98=l9_92;
float l9_99=1.0;
sc_ClampUV(l9_98,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_97,l9_99);
float l9_100=l9_98;
float l9_101=l9_99;
bool l9_102;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_102=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_102=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_103=l9_94;
float l9_104=l9_101;
sc_ClampUV(l9_103,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_102,l9_104);
l9_96=l9_104;
...
#endif
vec2 l9_105=sc_TransformUV(l9_95,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_106=l9_105.x;
float l9_107=l9_96;
sc_SoftwareWrapLate(l9_106,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_107);
float l9_108=l9_105.y;
float l9_109=l9_107;
sc_SoftwareWrapLate(l9_108,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_109);
float l9_110=l9_109;
vec3 l9_111=sc_SamplingCoordsViewToGlobal(vec2(l9_106,l9_108),capsule_btn_refl_tex_1Layout,capsule_btn_refl_tex_1GetStereoViewIndex());
vec4 l9_112=texture2D(capsule_btn_refl_tex_1,l9_111.xy,0.0);
vec4 l9_113;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_113=mix(capsule_btn_refl_tex_1BorderColor,l9_112,vec4(l9_110));
}
#else
{
l9_113=l9_112;
...
#endif
vec4 l9_114=smoothstep(Port_Input0_N020,Port_Input1_N020,l9_113);
vec4 l9_115=mix(l9_87,Port_Input1_N050,mix(Port_Input0_N048,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023),l9_114));
float l9_116=radians(Port_Rotation_N035);
float l9_117=clamp((vec2(dot(vec2(cos(l9_116),sin(l9_116)),l9_90-Port_Center_N035),0.0)+Port_Center_N035).x,0.0,1.0);
float l9_118;
if (l9_117<Port_Position1_N030)
{
l9_118=mix(Port_Value0_N030,Port_Value1_N030,clamp(l9_117/Port_Position1_N030,0.0,1.0));
}
else
{
float l9_119;
if (l9_117<Port_Position2_N030)
{
l9_119=mix(Port_Value1_N030,Port_Value2_N030,clamp((l9_117-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0));
}
else
{
float l9_120;
if (l9_117<Port_Position3_N030)
{
l9_120=mix(Port_Value2_N030,Port_Value3_N030,clamp((l9_117-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0));
}
else
{
l9_120=mix(Port_Value3_N030,Port_Value4_N030,clamp((l9_117-Port_Position3_N030)/(1.0-Port_Position3_N030),0.0,1.0));
}
l9_119=l9_120;
}
l9_118=l9_119;
}
vec4 l9_121=vec4(l9_115.x,l9_115.y,l9_115.z,vec4(0.0).w);
l9_121.w=l9_118;
vec4 l9_122=l9_57+l9_121;
...
#if (sc_FramebufferFetch)
{
vec4 l9_140=sc_readFragData0_Platform();
vec4 l9_141;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_142=l9_140;
l9_142.x=l9_140.x+_sc_framebufferFetchMarker;
l9_141=l9_142;
}
#else
{
...
{
l9_144=1-sc_GetStereoViewIndex();
}
#else
{
l9_144=sc_GetStereoViewIndex();
}
#endif
l9_139=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_143,sc_ScreenTextureLayout,l9_144).xy,0.0);
}
#endif
vec4 l9_145;
...
{
vec4 l9_146=l9_139;
l9_146.x=l9_139.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_145=l9_146;
}
#else
{
...
#endif
vec3 l9_147=mix(l9_145.xyz,definedBlend(l9_145.xyz,l9_122.xyz).xyz,vec3(l9_123));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_149=vec4(mix(vec3(1.0),l9_122.xyz,vec3(l9_123)),l9_123);
}
#else
{
vec4 l9_150;
...
#endif
l9_150=vec4(l9_122.xyz*l9_151,l9_151);
}
#else
{
l9_150=l9_122;
...
vec4 l9_156=outputMotionVectorsIfNeeded(varPos,max(l9_155,vec4(0.0)));
...
#endif
int l9_160=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_159).xy);
...
if (l9_177==0)
{
l9_180=texture2D(sc_OITAlpha0,l9_172);
l9_179=texture2D(sc_OITDepthLow0,l9_172);
l9_178=texture2D(sc_OITDepthHigh0,l9_172);
}
else
{
l9_180=vec4(0.0);
...
if (l9_177==1)
{
l9_183=texture2D(sc_OITAlpha1,l9_172);
l9_182=texture2D(sc_OITDepthLow1,l9_172);
l9_181=texture2D(sc_OITDepthHigh1,l9_172);
}
else
{
l9_183=l9_180;
...
vec4 l9_198=texture2D(sc_OITFilteredDepthBoundsTexture,l9_172);
