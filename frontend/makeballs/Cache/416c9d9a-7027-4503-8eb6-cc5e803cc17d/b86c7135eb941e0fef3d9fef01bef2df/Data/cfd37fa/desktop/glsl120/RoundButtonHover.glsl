...
//sampler sampler simple_round_buttonSmpSC 0:24
...
//texture texture2D simple_round_button 0:15:0:24
//SG_REFLECTION_END
...
vec3 l9_6=l9_3*l9_5;
vec3 l9_7=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_6,0.0)).xyz*vec3(Port_Input1_N037))+vec3(Port_Input2_N037);
int l9_8;
...
#endif
float l9_9=l9_7.x;
sc_SoftwareWrapEarly(l9_9,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x);
float l9_10=l9_9;
float l9_11=l9_7.y;
sc_SoftwareWrapEarly(l9_11,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y);
float l9_12=l9_11;
vec2 l9_13;
float l9_14;
...
{
l9_15=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x==3;
}
#else
{
l9_15=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_16=l9_10;
float l9_17=1.0;
sc_ClampUV(l9_16,simple_round_buttonUvMinMax.x,simple_round_buttonUvMinMax.z,l9_15,l9_17);
float l9_18=l9_16;
float l9_19=l9_17;
bool l9_20;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_20=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y==3;
}
#else
{
l9_20=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_21=l9_12;
float l9_22=l9_19;
sc_ClampUV(l9_21,simple_round_buttonUvMinMax.y,simple_round_buttonUvMinMax.w,l9_20,l9_22);
l9_14=l9_22;
...
#endif
vec2 l9_23=sc_TransformUV(l9_13,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform);
float l9_24=l9_23.x;
float l9_25=l9_14;
sc_SoftwareWrapLate(l9_24,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_25);
float l9_26=l9_23.y;
float l9_27=l9_25;
sc_SoftwareWrapLate(l9_26,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_27);
float l9_28=l9_27;
vec3 l9_29=sc_SamplingCoordsViewToGlobal(vec2(l9_24,l9_26),simple_round_buttonLayout,l9_8);
vec4 l9_30=texture2D(simple_round_button,l9_29.xy,0.0);
vec4 l9_31;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_31=mix(simple_round_buttonBorderColor,l9_30,vec4(l9_28));
}
#else
{
l9_31=l9_30;
...
float l9_33=clamp(length((varPackedTex.xy*Port_Input1_N010)+Port_Input2_N010),0.0,1.0);
vec4 l9_34;
...
{
vec4 l9_36;
if (l9_33<Port_Position3_N007)
{
l9_36=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_33-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_36=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_33-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_35=l9_36;
}
l9_34=l9_35;
}
vec4 l9_37=mix(l9_34,Port_Input1_N035,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_38=l9_37.w;
vec3 l9_39=(l9_32.xyz+Port_Input1_N002)+l9_37.xyz;
vec4 l9_40=vec4(l9_39.x,l9_39.y,l9_39.z,vec4(0.0).w);
l9_40.w=l9_38;
#if (sc_BlendMode_AlphaTest)
{
if (l9_38<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_38<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_44=clamp(dot(l9_40.xyz,vec3(l9_38)),0.0,1.0);
}
#else
{
float l9_45;
...
{
l9_46=(1.0-dot(l9_40.xyz,vec3(0.33333001)))*l9_38;
}
#else
{
float l9_47;
...
{
l9_47=(1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0))*l9_38;
}
#else
{
float l9_48;
...
{
l9_48=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*l9_38;
}
#else
{
float l9_49;
#if (sc_BlendMode_Add)
{
l9_49=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_50;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_50=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0)*l9_38;
}
#else
{
float l9_51;
...
{
l9_51=dot(l9_40.xyz,vec3(0.33333001))*l9_38;
}
#else
{
float l9_52;
#if (sc_BlendMode_Min)
{
l9_52=1.0-clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_53;
#if (sc_BlendMode_Max)
{
l9_53=clamp(dot(l9_40.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_53=1.0;
...
#endif
l9_41=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_40.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_42);
}
#else
{
vec4 l9_54;
...
#endif
vec3 l9_64=mix(l9_62.xyz,definedBlend(l9_62.xyz,l9_40.xyz).xyz,vec3(l9_38));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_66=vec4(mix(vec3(1.0),l9_40.xyz,vec3(l9_38)),l9_38);
}
#else
{
vec4 l9_67;
...
#endif
l9_67=vec4(l9_40.xyz*l9_68,l9_68);
}
#else
{
l9_67=l9_40;
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_75-0.0039215689)),min(1.0,l9_75+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_77),packValue(l9_77),packValue(l9_77),packValue(l9_77)));
