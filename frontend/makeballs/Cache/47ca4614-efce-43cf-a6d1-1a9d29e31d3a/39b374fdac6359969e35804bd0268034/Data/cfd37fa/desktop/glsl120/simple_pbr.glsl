...
#endif
float l9_27=clamp(l9_25.w,0.0,1.0);
...
#endif
vec3 l9_28=max(l9_25.xyz,vec3(0.0));
vec4 l9_29;
#if (sc_ProjectiveShadowsCaster)
{
...
vec3 l9_34=ssSRGB_to_Linear(Port_Emissive_N006);
vec3 l9_35;
#if (sc_SSAOEnabled)
{
...
SurfaceProperties l9_39=SurfaceProperties(l9_38,l9_27,l9_33,varPos,l9_0,l9_30,l9_31,l9_34,l9_35,Port_SpecularAO_N006,vec3(1.0),l9_37);
vec4 l9_40=vec4(1.0);
vec3 l9_41;
vec3 l9_42;
vec3 l9_43;
...
vec3 l9_152=l9_132*Port_SpecularAO_N006;
...
{
vec4 l9_160=l9_158;
l9_160.x=l9_157+((l9_35.x*Port_SpecularAO_N006.x)*9.9999997e-06);
l9_159=l9_160;
}
#else
{
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_195-0.0039215689)),min(1.0,l9_195+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_197),packValue(l9_197),packValue(l9_197),packValue(l9_197)));
