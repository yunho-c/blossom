...
{
l9_239=innerColorMultiplier;
}
else
{
l9_239=outerColorMultiplier;
}
vec4 l9_240=l9_238*vec4(l9_239+1.0);
float l9_241=l9_238.w;
vec4 l9_242=vec4(l9_240.x,l9_240.y,l9_240.z,vec4(0.0).w);
l9_242.w=l9_241;
vec4 l9_243;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_245=clamp(l9_241*2.0,0.0,1.0);
}
#else
{
float l9_246;
...
{
l9_246=clamp(dot(l9_242.xyz,vec3(l9_241)),0.0,1.0);
}
#else
{
float l9_247;
...
#if (sc_BlendMode_Multiply)
{
l9_248=(1.0-dot(l9_242.xyz,vec3(0.33333001)))*l9_241;
}
#else
{
float l9_249;
...
{
l9_249=(1.0-clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0))*l9_241;
}
#else
{
float l9_250;
#if (sc_BlendMode_ColoredGlass)
{
l9_250=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0)*l9_241;
}
#else
{
float l9_251;
#if (sc_BlendMode_Add)
{
l9_251=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_252;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_252=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0)*l9_241;
}
#else
{
float l9_253;
...
{
l9_253=dot(l9_242.xyz,vec3(0.33333001))*l9_241;
}
#else
{
float l9_254;
#if (sc_BlendMode_Min)
{
l9_254=1.0-clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_255;
#if (sc_BlendMode_Max)
{
l9_255=clamp(dot(l9_242.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_255=1.0;
...
#endif
l9_243=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_242.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_244);
}
#else
{
vec4 l9_256;
...
{
vec3 l9_258=sc_GetFramebufferColor().xyz;
vec3 l9_259=mix(l9_258,definedBlend(l9_258,l9_242.xyz).xyz,vec3(l9_241));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_261=vec4(mix(vec3(1.0),l9_242.xyz,vec3(l9_241)),l9_241);
}
#else
{
vec4 l9_262;
...
#endif
l9_262=vec4(l9_242.xyz*l9_263,l9_263);
}
#else
{
l9_262=l9_242;
...
{
l9_266=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_266=vec4(0.0);
...
vec4 l9_268=outputMotionVectorsIfNeeded(varPos,max(l9_267,vec4(0.0)));
vec4 l9_269=clamp(l9_268,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_270=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_270-0.0039215689)),min(1.0,l9_270+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_271=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_271).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_272=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_271).xy);
float l9_273=packValue(l9_272);
int l9_280=int(l9_269.w*255.0);
float l9_281=packValue(l9_280);
sc_writeFragData0(vec4(packValue(l9_272),packValue(l9_272),packValue(l9_272),packValue(l9_272)));
sc_writeFragData1(vec4(l9_273,packValue(l9_272),packValue(l9_272),packValue(l9_272)));
sc_writeFragData2(vec4(l9_281,packValue(l9_280),packValue(l9_280),packValue(l9_280)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_284=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_284).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_289==0)
{
l9_292=texture2D(sc_OITAlpha0,l9_284);
l9_291=texture2D(sc_OITDepthLow0,l9_284);
l9_290=texture2D(sc_OITDepthHigh0,l9_284);
}
else
{
l9_292=vec4(0.0);
...
if (l9_289==1)
{
l9_295=texture2D(sc_OITAlpha1,l9_284);
l9_294=texture2D(sc_OITDepthLow1,l9_284);
l9_293=texture2D(sc_OITDepthHigh1,l9_284);
}
else
{
l9_295=l9_292;
...
if (any(notEqual(l9_293,vec4(0.0)))||any(notEqual(l9_294,vec4(0.0))))
{
int l9_296[8]=l9_285;
unpackValues(l9_293.w,l9_289,l9_296);
unpackValues(l9_293.z,l9_289,l9_296);
unpackValues(l9_293.y,l9_289,l9_296);
unpackValues(l9_293.x,l9_289,l9_296);
unpackValues(l9_294.w,l9_289,l9_296);
unpackValues(l9_294.z,l9_289,l9_296);
unpackValues(l9_294.y,l9_289,l9_296);
unpackValues(l9_294.x,l9_289,l9_296);
int l9_305[8]=l9_286;
unpackValues(l9_295.w,l9_289,l9_305);
unpackValues(l9_295.z,l9_289,l9_305);
unpackValues(l9_295.y,l9_289,l9_305);
unpackValues(l9_295.x,l9_289,l9_305);
}
l9_289++;
continue;
}
...
vec4 l9_310=texture2D(sc_OITFilteredDepthBoundsTexture,l9_284);
vec2 l9_311=l9_310.xy;
int l9_312;
#if (sc_SkinBonesCount>0)
{
l9_312=encodeDepth(((1.0-l9_310.x)*1000.0)+getDepthOrderingEpsilon(),l9_311);
}
#else
{
l9_312=0;
...
#endif
int l9_313=encodeDepth(viewSpaceDepth(),l9_311);
vec4 l9_314;
l9_314=l9_269*l9_269.w;
vec4 l9_315;
int l9_316=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_316<8)
{
int l9_317=l9_285[l9_316];
int l9_318=l9_313-l9_312;
bool l9_319=l9_317<l9_318;
bool l9_320;
if (l9_319)
{
l9_320=l9_285[l9_316]>0;
}
else
{
l9_320=l9_319;
...
if (l9_320)
{
vec3 l9_321=l9_314.xyz*(1.0-(float(l9_286[l9_316])/255.0));
l9_315=vec4(l9_321.x,l9_321.y,l9_321.z,l9_314.w);
}
else
{
l9_315=l9_314;
