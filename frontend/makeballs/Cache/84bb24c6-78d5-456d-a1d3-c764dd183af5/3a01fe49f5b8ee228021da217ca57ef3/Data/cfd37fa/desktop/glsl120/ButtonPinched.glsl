...
vec3 l9_5=l9_2*l9_4;
vec3 l9_6=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_5,0.0)).xyz*vec3(Port_Input1_N073))+vec3(Port_Input2_N073);
int l9_7;
...
float l9_27=l9_26;
vec3 l9_28=sc_SamplingCoordsViewToGlobal(vec2(l9_23,l9_25),additional_settings_btn_refl_texLayout,l9_7);
...
#endif
vec4 l9_31=vec4(Port_Import_N062)*l9_30;
float l9_32=clamp(length((varPackedTex.xy*Port_Input1_N009)+Port_Input2_N009),0.0,1.0);
vec4 l9_33;
if (l9_32<Port_Position1_N014)
{
l9_33=mix(Port_Value0_N014,Port_Value1_N014,vec4(clamp(l9_32/Port_Position1_N014,0.0,1.0)));
}
else
{
vec4 l9_34;
if (l9_32<Port_Position2_N014)
{
l9_34=mix(Port_Value1_N014,Port_Value2_N014,vec4(clamp((l9_32-Port_Position1_N014)/(Port_Position2_N014-Port_Position1_N014),0.0,1.0)));
}
else
{
l9_34=mix(Port_Value2_N014,Port_Value3_N014,vec4(clamp((l9_32-Port_Position2_N014)/(1.0-Port_Position2_N014),0.0,1.0)));
}
l9_33=l9_34;
}
vec4 l9_35=l9_31+l9_33;
vec2 l9_36=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
float l9_37=l9_36.x;
float l9_38=l9_37;
sc_SoftwareWrapEarly(l9_38,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_39=l9_38;
float l9_40=l9_36.y;
float l9_41=l9_40;
sc_SoftwareWrapEarly(l9_41,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_42=l9_41;
vec2 l9_43;
float l9_44;
...
{
l9_45=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_45=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_46=l9_39;
float l9_47=1.0;
sc_ClampUV(l9_46,iconUvMinMax.x,iconUvMinMax.z,l9_45,l9_47);
float l9_48=l9_46;
float l9_49=l9_47;
bool l9_50;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_50=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_50=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_51=l9_42;
float l9_52=l9_49;
sc_ClampUV(l9_51,iconUvMinMax.y,iconUvMinMax.w,l9_50,l9_52);
l9_44=l9_52;
...
{
l9_44=1.0;
l9_43=vec2(l9_39,l9_42);
}
#endif
vec2 l9_53=sc_TransformUV(l9_43,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_54=l9_53.x;
float l9_55=l9_44;
sc_SoftwareWrapLate(l9_54,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_55);
float l9_56=l9_53.y;
float l9_57=l9_55;
sc_SoftwareWrapLate(l9_56,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_57);
float l9_58=l9_57;
vec3 l9_59=sc_SamplingCoordsViewToGlobal(vec2(l9_54,l9_56),iconLayout,iconGetStereoViewIndex());
vec4 l9_60=texture2D(icon,l9_59.xy,0.0);
vec4 l9_61;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_61=mix(iconBorderColor,l9_60,vec4(l9_58));
}
#else
{
l9_61=l9_60;
...
{
float l9_63=l9_37;
sc_SoftwareWrapEarly(l9_63,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_64=l9_63;
float l9_65=l9_40;
sc_SoftwareWrapEarly(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_66=l9_65;
vec2 l9_67;
float l9_68;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_69=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_69=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_70=l9_64;
float l9_71=1.0;
sc_ClampUV(l9_70,iconUvMinMax.x,iconUvMinMax.z,l9_69,l9_71);
float l9_72=l9_70;
float l9_73=l9_71;
bool l9_74;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
l9_74=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_75=l9_66;
float l9_76=l9_73;
sc_ClampUV(l9_75,iconUvMinMax.y,iconUvMinMax.w,l9_74,l9_76);
l9_68=l9_76;
...
#endif
vec2 l9_77=sc_TransformUV(l9_67,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_78=l9_77.x;
float l9_79=l9_68;
sc_SoftwareWrapLate(l9_78,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_79);
float l9_80=l9_77.y;
float l9_81=l9_79;
sc_SoftwareWrapLate(l9_80,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_81);
float l9_82=l9_81;
vec3 l9_83=sc_SamplingCoordsViewToGlobal(vec2(l9_78,l9_80),iconLayout,iconGetStereoViewIndex());
vec4 l9_84=texture2D(icon,l9_83.xy,0.0);
vec4 l9_85;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_85=mix(iconBorderColor,l9_84,vec4(l9_82));
}
#else
{
l9_85=l9_84;
...
{
l9_62=Port_Input2_N003;
}
vec4 l9_86=vec4(l9_62);
vec4 l9_87=mix(l9_35,l9_61,l9_86);
float l9_88=l9_87.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_88<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_88<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_92=clamp(dot(l9_87.xyz,vec3(l9_88)),0.0,1.0);
}
#else
{
float l9_93;
...
{
l9_94=(1.0-dot(l9_87.xyz,vec3(0.33333001)))*l9_88;
}
#else
{
float l9_95;
...
{
l9_95=(1.0-clamp(dot(l9_87.xyz,vec3(1.0)),0.0,1.0))*l9_88;
}
#else
{
float l9_96;
...
{
l9_96=clamp(dot(l9_87.xyz,vec3(1.0)),0.0,1.0)*l9_88;
}
#else
{
float l9_97;
#if (sc_BlendMode_Add)
{
l9_97=clamp(dot(l9_87.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_98;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_98=clamp(dot(l9_87.xyz,vec3(1.0)),0.0,1.0)*l9_88;
}
#else
{
float l9_99;
...
{
l9_99=dot(l9_87.xyz,vec3(0.33333001))*l9_88;
}
#else
{
float l9_100;
#if (sc_BlendMode_Min)
{
l9_100=1.0-clamp(dot(l9_87.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_101;
#if (sc_BlendMode_Max)
{
l9_101=clamp(dot(l9_87.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_101=1.0;
...
#endif
l9_89=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_87.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_90);
}
#else
{
vec4 l9_102;
...
#if (sc_FramebufferFetch)
{
vec4 l9_105=sc_readFragData0_Platform();
vec4 l9_106;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_107=l9_105;
l9_107.x=l9_105.x+_sc_framebufferFetchMarker;
l9_106=l9_107;
}
#else
{
...
#endif
l9_104=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_108,sc_ScreenTextureLayout,l9_109).xy,0.0);
}
#endif
vec4 l9_110;
...
{
vec4 l9_111=l9_104;
l9_111.x=l9_104.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_110=l9_111;
}
#else
{
...
#endif
vec3 l9_112=mix(l9_110.xyz,definedBlend(l9_110.xyz,l9_87.xyz).xyz,vec3(l9_88));
vec4 l9_113=vec4(l9_112.x,l9_112.y,l9_112.z,vec4(0.0).w);
l9_113.w=1.0;
l9_103=l9_113;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_114=vec4(mix(vec3(1.0),l9_87.xyz,vec3(l9_88)),l9_88);
}
#else
{
vec4 l9_115;
...
#endif
l9_115=vec4(l9_87.xyz*l9_116,l9_116);
}
#else
{
l9_115=l9_87;
...
{
l9_119=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_119=vec4(0.0);
...
vec4 l9_121=outputMotionVectorsIfNeeded(varPos,max(l9_120,vec4(0.0)));
vec4 l9_122=clamp(l9_121,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_123=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_123-0.0039215689)),min(1.0,l9_123+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_125=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_124).xy);
float l9_126=packValue(l9_125);
int l9_133=int(l9_122.w*255.0);
float l9_134=packValue(l9_133);
sc_writeFragData0(vec4(packValue(l9_125),packValue(l9_125),packValue(l9_125),packValue(l9_125)));
sc_writeFragData1(vec4(l9_126,packValue(l9_125),packValue(l9_125),packValue(l9_125)));
sc_writeFragData2(vec4(l9_134,packValue(l9_133),packValue(l9_133),packValue(l9_133)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_137).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_142==0)
{
l9_145=texture2D(sc_OITAlpha0,l9_137);
l9_144=texture2D(sc_OITDepthLow0,l9_137);
l9_143=texture2D(sc_OITDepthHigh0,l9_137);
}
else
{
l9_145=vec4(0.0);
...
if (l9_142==1)
{
l9_148=texture2D(sc_OITAlpha1,l9_137);
l9_147=texture2D(sc_OITDepthLow1,l9_137);
l9_146=texture2D(sc_OITDepthHigh1,l9_137);
}
else
{
l9_148=l9_145;
...
if (any(notEqual(l9_146,vec4(0.0)))||any(notEqual(l9_147,vec4(0.0))))
{
int l9_149[8]=l9_138;
unpackValues(l9_146.w,l9_142,l9_149);
unpackValues(l9_146.z,l9_142,l9_149);
unpackValues(l9_146.y,l9_142,l9_149);
unpackValues(l9_146.x,l9_142,l9_149);
unpackValues(l9_147.w,l9_142,l9_149);
unpackValues(l9_147.z,l9_142,l9_149);
unpackValues(l9_147.y,l9_142,l9_149);
unpackValues(l9_147.x,l9_142,l9_149);
int l9_158[8]=l9_139;
unpackValues(l9_148.w,l9_142,l9_158);
unpackValues(l9_148.z,l9_142,l9_158);
unpackValues(l9_148.y,l9_142,l9_158);
unpackValues(l9_148.x,l9_142,l9_158);
}
l9_142++;
continue;
}
...
vec4 l9_163=texture2D(sc_OITFilteredDepthBoundsTexture,l9_137);
vec2 l9_164=l9_163.xy;
int l9_165;
#if (sc_SkinBonesCount>0)
{
l9_165=encodeDepth(((1.0-l9_163.x)*1000.0)+getDepthOrderingEpsilon(),l9_164);
}
#else
{
l9_165=0;
...
#endif
int l9_166=encodeDepth(viewSpaceDepth(),l9_164);
vec4 l9_167;
l9_167=l9_122*l9_122.w;
vec4 l9_168;
int l9_169=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_169<8)
{
int l9_170=l9_138[l9_169];
int l9_171=l9_166-l9_165;
bool l9_172=l9_170<l9_171;
bool l9_173;
if (l9_172)
{
l9_173=l9_138[l9_169]>0;
}
else
{
l9_173=l9_172;
...
if (l9_173)
{
vec3 l9_174=l9_167.xyz*(1.0-(float(l9_139[l9_169])/255.0));
l9_168=vec4(l9_174.x,l9_174.y,l9_174.z,l9_167.w);
}
else
{
l9_168=l9_167;
