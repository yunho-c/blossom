...
//}
//ubo int UserUniforms 0:35:4608 {
...
int l9_11=l9_10;
VectorOut_N71=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_11]*float4(Output_N70,0.0)).xyz;
...
float4 param_14=(*sc_set0.UserUniforms).Port_Value0_N014;
float param_15=(*sc_set0.UserUniforms).Port_Position1_N014;
float4 param_16=(*sc_set0.UserUniforms).Port_Value1_N014;
float param_17=(*sc_set0.UserUniforms).Port_Position2_N014;
float4 param_18=(*sc_set0.UserUniforms).Port_Value2_N014;
float4 param_19=(*sc_set0.UserUniforms).Port_Value3_N014;
...
float3x3 param_25=(*sc_set0.UserUniforms).iconTransform;
...
float4 param_28=(*sc_set0.UserUniforms).iconUvMinMax;
bool param_29=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 param_30=(*sc_set0.UserUniforms).iconBorderColor;
float param_31=0.0;
...
float l9_167=l9_159;
float4 l9_168=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_166,bias(l9_167));
...
float param_32=1.0;
float param_33=1.0;
float param_34=(*sc_set0.UserUniforms).Port_Input2_N003;
ssGlobals param_36=Globals;
float l9_172=0.0;
float l9_173=float((*sc_set0.UserUniforms).iconEnabled!=0);
l9_172=l9_173;
param_32=l9_172;
float param_35;
if ((param_32*1.0)!=0.0)
...
float3x3 l9_187=(*sc_set0.UserUniforms).iconTransform;
...
float4 l9_190=(*sc_set0.UserUniforms).iconUvMinMax;
bool l9_191=(int(SC_USE_CLAMP_TO_BORDER_icon_tmp)!=0);
float4 l9_192=(*sc_set0.UserUniforms).iconBorderColor;
float l9_193=0.0;
...
float l9_263=l9_255;
float4 l9_264=sc_set0.icon.sample(sc_set0.iconSmpSC,l9_262,bias(l9_263));
...
bool l9_274=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_274)
{
...
float l9_279=l9_278;
float l9_280=l9_279;
float l9_281=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_280;
float3 l9_282=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_276.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_288.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float l9_328=l9_320;
float4 l9_329=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_327,bias(l9_328));
...
float3 l9_339=definedBlend(l9_337,l9_338,in.varStereoViewID,(*sc_set0.UserUniforms),sc_set0.intensityTexture,sc_set0.intensityTextureSmpSC);
...
{
l9_347=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_347=float4(0.0);
...
FinalColor=outputMotionVectorsIfNeeded(param_41,param_42,in.varStereoViewID,(*sc_set0.UserUniforms));
