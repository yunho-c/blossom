...
vec4 l9_89;
if (l9_88<Port_Position1_N030)
{
l9_89=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_88/Port_Position1_N030,0.0,1.0)));
}
else
{
vec4 l9_90;
if (l9_88<Port_Position2_N030)
{
l9_90=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_88-Port_Position1_N030)/(Port_Position2_N030-Port_Position1_N030),0.0,1.0)));
}
else
{
vec4 l9_91;
if (l9_88<Port_Position3_N030)
{
l9_91=mix(Port_Value2_N030,Port_Value3_N030,vec4(clamp((l9_88-Port_Position2_N030)/(Port_Position3_N030-Port_Position2_N030),0.0,1.0)));
}
else
{
vec4 l9_92;
if (l9_88<Port_Position4_N030)
{
l9_92=mix(Port_Value3_N030,Port_Value4_N030,vec4(clamp((l9_88-Port_Position3_N030)/(Port_Position4_N030-Port_Position3_N030),0.0,1.0)));
}
else
{
l9_92=mix(Port_Value4_N030,Port_Value5_N030,vec4(clamp((l9_88-Port_Position4_N030)/(1.0-Port_Position4_N030),0.0,1.0)));
}
l9_91=l9_92;
}
l9_90=l9_91;
...
vec4 l9_93=mix(l9_89,Port_Input1_N000,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N001)),Port_Exponent_N001),0.0)*Port_Intensity_N001));
vec4 l9_94=l9_57+l9_93;
float l9_95=l9_94.w;
