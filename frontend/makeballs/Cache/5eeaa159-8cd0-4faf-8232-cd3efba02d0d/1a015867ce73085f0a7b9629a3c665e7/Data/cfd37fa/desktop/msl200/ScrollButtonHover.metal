...
//}
//ubo int UserUniforms 0:37:5184 {
...
float4 param_38=(*sc_set0.UserUniforms).Port_Value0_N005;
float param_39=(*sc_set0.UserUniforms).Port_Position1_N005;
float4 param_40=(*sc_set0.UserUniforms).Port_Value1_N005;
float param_41=(*sc_set0.UserUniforms).Port_Position2_N005;
float4 param_42=(*sc_set0.UserUniforms).Port_Value2_N005;
float4 param_43=(*sc_set0.UserUniforms).Port_Value3_N005;
...
Value_N5=param_44;
float Rim_N64=0.0;
float3 param_45=(*sc_set0.UserUniforms).Port_Normal_N064;
float param_46=(*sc_set0.UserUniforms).Port_Exponent_N064;
float param_47=(*sc_set0.UserUniforms).Port_Intensity_N064;
...
float4 param_51=(*sc_set0.UserUniforms).Port_Value0_N069;
float param_52=(*sc_set0.UserUniforms).Port_Position1_N069;
float4 param_53=(*sc_set0.UserUniforms).Port_Value1_N069;
float param_54=(*sc_set0.UserUniforms).Port_Position2_N069;
float4 param_55=(*sc_set0.UserUniforms).Port_Value2_N069;
float param_56=(*sc_set0.UserUniforms).Port_Position3_N069;
float4 param_57=(*sc_set0.UserUniforms).Port_Value3_N069;
float4 param_58=(*sc_set0.UserUniforms).Port_Value4_N069;
...
float Rim_N91=0.0;
float3 param_60=(*sc_set0.UserUniforms).Port_Normal_N091;
float param_61=(*sc_set0.UserUniforms).Port_Exponent_N091;
float param_62=(*sc_set0.UserUniforms).Port_Intensity_N091;
...
ValueOut_N76=(((UVCoord_N119-float2((*sc_set0.UserUniforms).Port_RangeMinA_N076))/float2((*sc_set0.UserUniforms).Port_RangeMaxA_N076-(*sc_set0.UserUniforms).Port_RangeMinA_N076))*((*sc_set0.UserUniforms).Port_RangeMaxB_N076-(*sc_set0.UserUniforms).Port_RangeMinB_N076))+float2((*sc_set0.UserUniforms).Port_RangeMinB_N076);
float2 CoordsOut_N90=float2(0.0);
float2 param_65=(*sc_set0.UserUniforms).Port_CoordsIn_N090;
float param_66=(*sc_set0.UserUniforms).Port_Rotation_N090;
float2 param_67=(*sc_set0.UserUniforms).Port_Center_N090;
...
float param_70=(*sc_set0.UserUniforms).Port_Value0_N016;
float param_71=(*sc_set0.UserUniforms).Port_Position1_N016;
float param_72=(*sc_set0.UserUniforms).Port_Value1_N016;
float param_73=(*sc_set0.UserUniforms).Port_Position2_N016;
float param_74=(*sc_set0.UserUniforms).Port_Value2_N016;
float param_75=(*sc_set0.UserUniforms).Port_Position3_N016;
float param_76=(*sc_set0.UserUniforms).Port_Value3_N016;
float param_77=(*sc_set0.UserUniforms).Port_Value4_N016;
...
{
if (param_79<(*sc_set0.UserUniforms).alphaTestThreshold)
{
discard_fragment();
}
}
