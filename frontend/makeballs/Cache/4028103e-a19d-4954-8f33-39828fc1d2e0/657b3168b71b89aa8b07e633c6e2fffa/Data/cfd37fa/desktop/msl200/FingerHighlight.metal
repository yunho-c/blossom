...
//}
//ubo int UserUniforms 0:35:4512 {
...
//float4 fingertipSize 4192
//float4 fingertipDims 4208
//float4 fingertipView 4224
//float3x3 fingertipTransform 4240
//float4 fingertipUvMinMax 4288
//float4 fingertipBorderColor 4304
//float4 handGlowTexSize 4320
//float4 handGlowTexDims 4336
//float4 handGlowTexView 4352
//float3x3 handGlowTexTransform 4368
//float4 handGlowTexUvMinMax 4416
//float4 handGlowTexBorderColor 4432
//float blend_coef 4448
//float4 thumbGlowColor 4464
//float thumbBrightness 4480
//float Port_Input0_N003 4484
//float Port_Input0_N011 4488
//float Port_Mask_N014 4492
//float depthRef 4496
//}
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_fingertip 31
//spec_const bool SC_USE_CLAMP_TO_BORDER_handGlowTex 32
//spec_const bool SC_USE_CLAMP_TO_BORDER_intensityTexture 33
//spec_const bool SC_USE_UV_MIN_MAX_fingertip 34
//spec_const bool SC_USE_UV_MIN_MAX_handGlowTex 35
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 36
//spec_const bool SC_USE_UV_TRANSFORM_fingertip 37
//spec_const bool SC_USE_UV_TRANSFORM_handGlowTex 38
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 39
//spec_const bool UseViewSpaceDepthVariant 40
//spec_const bool fingertipHasSwappedViews 41
//spec_const bool handGlowTexHasSwappedViews 42
...
//spec_const int SC_SOFTWARE_WRAP_MODE_U_fingertip 74
//spec_const int SC_SOFTWARE_WRAP_MODE_U_handGlowTex 75
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 76
//spec_const int SC_SOFTWARE_WRAP_MODE_V_fingertip 77
//spec_const int SC_SOFTWARE_WRAP_MODE_V_handGlowTex 78
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 79
//spec_const int fingertipLayout 80
//spec_const int handGlowTexLayout 81
...
constant int SC_SOFTWARE_WRAP_MODE_U_fingertip [[function_constant(74)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_handGlowTex [[function_constant(75)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_fingertip [[function_constant(77)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_handGlowTex [[function_constant(78)]];
...
constant int fingertipLayout [[function_constant(80)]];
constant int fingertipLayout_tmp = is_function_constant_defined(fingertipLayout) ? fingertipLayout : 0;
constant int handGlowTexLayout [[function_constant(81)]];
...
int l9_12=l9_7;
int param_6=fingertipLayout_tmp;
int param_7=l9_12;
float2 param_8=UVCoord_N18;
bool param_9=(int(SC_USE_UV_TRANSFORM_fingertip_tmp)!=0);
float3x3 param_10=(*sc_set0.UserUniforms).fingertipTransform;
int2 param_11=int2(SC_SOFTWARE_WRAP_MODE_U_fingertip_tmp,SC_SOFTWARE_WRAP_MODE_V_fingertip_tmp);
bool param_12=(int(SC_USE_UV_MIN_MAX_fingertip_tmp)!=0);
float4 param_13=(*sc_set0.UserUniforms).fingertipUvMinMax;
bool param_14=(int(SC_USE_CLAMP_TO_BORDER_fingertip_tmp)!=0);
float4 param_15=(*sc_set0.UserUniforms).fingertipBorderColor;
float param_16=0.0;
...
float l9_82=l9_74;
float4 l9_83=sc_set0.fingertip.sample(sc_set0.fingertipSmpSC,l9_81,bias(l9_82));
float4 l9_84=l9_83;
float4 l9_85=l9_84;
if (param_14)
{
...
int l9_92=l9_87;
int param_17=handGlowTexLayout_tmp;
int param_18=l9_92;
float2 param_19=UVCoord_N0;
bool param_20=(int(SC_USE_UV_TRANSFORM_handGlowTex_tmp)!=0);
float3x3 param_21=(*sc_set0.UserUniforms).handGlowTexTransform;
int2 param_22=int2(SC_SOFTWARE_WRAP_MODE_U_handGlowTex_tmp,SC_SOFTWARE_WRAP_MODE_V_handGlowTex_tmp);
bool param_23=(int(SC_USE_UV_MIN_MAX_handGlowTex_tmp)!=0);
float4 param_24=(*sc_set0.UserUniforms).handGlowTexUvMinMax;
bool param_25=(int(SC_USE_CLAMP_TO_BORDER_handGlowTex_tmp)!=0);
float4 param_26=(*sc_set0.UserUniforms).handGlowTexBorderColor;
float param_27=0.0;
bool l9_93=param_25&&(!param_23);
float l9_94=1.0;
float l9_95=param_19.x;
int l9_96=param_22.x;
if (l9_96==1)
{
l9_95=fract(l9_95);
}
...
float l9_107=param_19.x;
float l9_108=param_24.x;
float l9_109=param_24.z;
bool l9_110=l9_106;
float l9_111=l9_94;
...
float l9_116=param_19.y;
float l9_117=param_24.y;
float l9_118=param_24.w;
bool l9_119=l9_115;
float l9_120=l9_94;
...
float2 l9_123=param_19;
bool l9_124=param_20;
float3x3 l9_125=param_21;
if (l9_124)
{
...
float l9_162=l9_154;
float4 l9_163=sc_set0.handGlowTex.sample(sc_set0.handGlowTexSmpSC,l9_161,bias(l9_162));
float4 l9_164=l9_163;
float4 l9_165=l9_164;
if (param_25)
{
l9_165=mix(param_26,l9_165,float4(l9_94));
}
float4 l9_166=l9_165;
Color_N1=l9_166;
float Output_N21=0.0;
float param_28=(*sc_set0.UserUniforms).blend_coef;
Output_N21=param_28;
...
float4 param_29=(*sc_set0.UserUniforms).thumbGlowColor;
Output_N15=param_29;
float Value1_N16=0.0;
float Value2_N16=0.0;
float Value3_N16=0.0;
float3 param_30=Output_N15.xyz;
float param_31=param_30.x;
float param_32=param_30.y;
float param_33=param_30.z;
Value1_N16=param_31;
Value2_N16=param_32;
Value3_N16=param_33;
float Output_N10=0.0;
float param_34=(*sc_set0.UserUniforms).thumbBrightness;
Output_N10=param_34;
...
float4 param_36=Value_N7;
float4 param_37=Value_N17;
float4 l9_167=param_36;
float4 l9_168=param_37;
float3 l9_169=l9_167.xyz*l9_167.w;
l9_167=float4(l9_169.x,l9_169.y,l9_169.z,l9_167.w);
float4 param_35=l9_167+(l9_168*(1.0-l9_167.w));
Output_N14=param_35;
...
float4 l9_174=fast::max(param_39,float4(0.0));
float4 param_40=l9_174;
if (sc_ShaderCacheConstant_tmp!=0)
{
