...
vec4 l9_69=mix(l9_61,Port_Input1_N024,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_3*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
vec2 l9_70=((varPackedTex.zw-Port_Center_N002)*Port_Scale_N002)+Port_Center_N002;
float l9_71=l9_70.x;
float l9_72=l9_71;
...
float l9_74=l9_70.y;
float l9_75=l9_74;
sc_SoftwareWrapEarly(l9_75,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_76=l9_75;
vec2 l9_77;
float l9_78;
...
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_80=l9_73;
float l9_81=1.0;
sc_ClampUV(l9_80,iconUvMinMax.x,iconUvMinMax.z,l9_79,l9_81);
float l9_82=l9_80;
float l9_83=l9_81;
bool l9_84;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_84=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_85=l9_76;
float l9_86=l9_83;
sc_ClampUV(l9_85,iconUvMinMax.y,iconUvMinMax.w,l9_84,l9_86);
l9_78=l9_86;
...
{
l9_78=1.0;
l9_77=vec2(l9_73,l9_76);
}
#endif
vec2 l9_87=sc_TransformUV(l9_77,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_88=l9_87.x;
float l9_89=l9_78;
sc_SoftwareWrapLate(l9_88,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_89);
float l9_90=l9_87.y;
float l9_91=l9_89;
sc_SoftwareWrapLate(l9_90,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_91);
float l9_92=l9_91;
vec3 l9_93=sc_SamplingCoordsViewToGlobal(vec2(l9_88,l9_90),iconLayout,iconGetStereoViewIndex());
vec4 l9_94=texture2D(icon,l9_93.xy,0.0);
vec4 l9_95;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_95=mix(iconBorderColor,l9_94,vec4(l9_92));
}
#else
{
l9_95=l9_94;
...
{
float l9_97=l9_71;
sc_SoftwareWrapEarly(l9_97,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x);
float l9_98=l9_97;
float l9_99=l9_74;
sc_SoftwareWrapEarly(l9_99,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y);
float l9_100=l9_99;
vec2 l9_101;
float l9_102;
#if (SC_USE_UV_MIN_MAX_icon)
...
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_103=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x==3;
}
#else
{
l9_103=(int(SC_USE_CLAMP_TO_BORDER_icon)!=0);
}
#endif
float l9_104=l9_98;
float l9_105=1.0;
sc_ClampUV(l9_104,iconUvMinMax.x,iconUvMinMax.z,l9_103,l9_105);
float l9_106=l9_104;
float l9_107=l9_105;
bool l9_108;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_108=ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y==3;
}
#else
{
...
float l9_109=l9_100;
float l9_110=l9_107;
sc_ClampUV(l9_109,iconUvMinMax.y,iconUvMinMax.w,l9_108,l9_110);
l9_102=l9_110;
...
#endif
vec2 l9_111=sc_TransformUV(l9_101,(int(SC_USE_UV_TRANSFORM_icon)!=0),iconTransform);
float l9_112=l9_111.x;
float l9_113=l9_102;
sc_SoftwareWrapLate(l9_112,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).x,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_113);
float l9_114=l9_111.y;
float l9_115=l9_113;
sc_SoftwareWrapLate(l9_114,ivec2(SC_SOFTWARE_WRAP_MODE_U_icon,SC_SOFTWARE_WRAP_MODE_V_icon).y,(int(SC_USE_CLAMP_TO_BORDER_icon)!=0)&&(!(int(SC_USE_UV_MIN_MAX_icon)!=0)),l9_115);
float l9_116=l9_115;
vec3 l9_117=sc_SamplingCoordsViewToGlobal(vec2(l9_112,l9_114),iconLayout,iconGetStereoViewIndex());
vec4 l9_118=texture2D(icon,l9_117.xy,0.0);
vec4 l9_119;
#if (SC_USE_CLAMP_TO_BORDER_icon)
{
l9_119=mix(iconBorderColor,l9_118,vec4(l9_116));
}
#else
{
l9_119=l9_118;
...
{
l9_96=Port_Input2_N007;
}
vec4 l9_120=vec4(l9_96);
vec4 l9_121=mix(mix(l9_31,l9_59,vec4(Port_Input2_N005))+l9_69,l9_95,l9_120);
...
#if (sc_FramebufferFetch)
{
vec4 l9_139=sc_readFragData0_Platform();
vec4 l9_140;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_141=l9_139;
l9_141.x=l9_139.x+_sc_framebufferFetchMarker;
l9_140=l9_141;
}
#else
{
...
{
l9_143=1-sc_GetStereoViewIndex();
}
#else
{
l9_143=sc_GetStereoViewIndex();
}
#endif
l9_138=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_142,sc_ScreenTextureLayout,l9_143).xy,0.0);
}
#endif
vec4 l9_144;
...
{
vec4 l9_145=l9_138;
l9_145.x=l9_138.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_144=l9_145;
}
#else
{
...
#endif
vec3 l9_146=mix(l9_144.xyz,definedBlend(l9_144.xyz,l9_121.xyz).xyz,vec3(l9_122));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_148=vec4(mix(vec3(1.0),l9_121.xyz,vec3(l9_122)),l9_122);
}
#else
{
vec4 l9_149;
...
#endif
l9_149=vec4(l9_121.xyz*l9_150,l9_150);
}
#else
{
l9_149=l9_121;
...
{
l9_153=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_153=vec4(0.0);
...
vec4 l9_155=outputMotionVectorsIfNeeded(varPos,max(l9_154,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_157-0.0039215689)),min(1.0,l9_157+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_158=sc_ScreenCoordsGlobalToView(gl_FragCoord.xy*sc_CurrentRenderTargetDims.zw);
...
sc_writeFragData0(vec4(packValue(l9_159),packValue(l9_159),packValue(l9_159),packValue(l9_159)));
