...
vec3 l9_5=l9_2*l9_4;
vec3 l9_6=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_5,0.0)).xyz*vec3(Port_Input1_N037))+vec3(Port_Input2_N037);
int l9_7;
...
#endif
float l9_8=l9_6.x;
sc_SoftwareWrapEarly(l9_8,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x);
float l9_9=l9_8;
float l9_10=l9_6.y;
sc_SoftwareWrapEarly(l9_10,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y);
float l9_11=l9_10;
vec2 l9_12;
float l9_13;
...
{
l9_14=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x==3;
}
#else
{
l9_14=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_15=l9_9;
float l9_16=1.0;
sc_ClampUV(l9_15,simple_round_buttonUvMinMax.x,simple_round_buttonUvMinMax.z,l9_14,l9_16);
float l9_17=l9_15;
float l9_18=l9_16;
bool l9_19;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_19=ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y==3;
}
#else
{
l9_19=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0);
}
#endif
float l9_20=l9_11;
float l9_21=l9_18;
sc_ClampUV(l9_20,simple_round_buttonUvMinMax.y,simple_round_buttonUvMinMax.w,l9_19,l9_21);
l9_13=l9_21;
...
#endif
vec2 l9_22=sc_TransformUV(l9_12,(int(SC_USE_UV_TRANSFORM_simple_round_button)!=0),simple_round_buttonTransform);
float l9_23=l9_22.x;
float l9_24=l9_13;
sc_SoftwareWrapLate(l9_23,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).x,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_24);
float l9_25=l9_22.y;
float l9_26=l9_24;
sc_SoftwareWrapLate(l9_25,ivec2(SC_SOFTWARE_WRAP_MODE_U_simple_round_button,SC_SOFTWARE_WRAP_MODE_V_simple_round_button).y,(int(SC_USE_CLAMP_TO_BORDER_simple_round_button)!=0)&&(!(int(SC_USE_UV_MIN_MAX_simple_round_button)!=0)),l9_26);
float l9_27=l9_26;
vec3 l9_28=sc_SamplingCoordsViewToGlobal(vec2(l9_23,l9_25),simple_round_buttonLayout,l9_7);
vec4 l9_29=texture2D(simple_round_button,l9_28.xy,0.0);
vec4 l9_30;
#if (SC_USE_CLAMP_TO_BORDER_simple_round_button)
{
l9_30=mix(simple_round_buttonBorderColor,l9_29,vec4(l9_27));
}
#else
{
l9_30=l9_29;
...
#endif
vec4 l9_31=vec4(Port_Import_N027)*l9_30;
float l9_32=clamp(length((varPackedTex.xy*Port_Input1_N010)+Port_Input2_N010),0.0,1.0);
vec4 l9_33;
if (l9_32<Port_Position1_N007)
{
l9_33=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_32/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_34;
...
{
l9_34=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_32-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_35;
if (l9_32<Port_Position3_N007)
{
l9_35=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_32-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_35=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_32-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_34=l9_35;
}
l9_33=l9_34;
}
vec3 l9_36=(l9_31.xyz+Port_Input1_N002)+l9_33.xyz;
vec4 l9_37=vec4(l9_36.x,l9_36.y,l9_36.z,vec4(0.0).w);
l9_37.w=l9_33.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_33.w<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_33.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_40=clamp(l9_33.w*2.0,0.0,1.0);
}
#else
{
float l9_41;
...
{
l9_41=clamp(dot(l9_37.xyz,vec3(l9_33.w)),0.0,1.0);
}
#else
{
float l9_42;
...
{
l9_43=(1.0-dot(l9_37.xyz,vec3(0.33333001)))*l9_33.w;
}
#else
{
float l9_44;
...
{
l9_44=(1.0-clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0))*l9_33.w;
}
#else
{
float l9_45;
...
{
l9_45=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*l9_33.w;
}
#else
{
float l9_46;
...
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_47=clamp(dot(l9_37.xyz,vec3(1.0)),0.0,1.0)*l9_33.w;
}
#else
{
float l9_48;
...
{
l9_48=dot(l9_37.xyz,vec3(0.33333001))*l9_33.w;
}
#else
{
float l9_49;
...
#endif
vec3 l9_61=mix(l9_59.xyz,definedBlend(l9_59.xyz,l9_37.xyz).xyz,vec3(l9_33.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_63=vec4(mix(vec3(1.0),l9_37.xyz,vec3(l9_33.w)),l9_33.w);
}
#else
{
vec4 l9_64;
