...
float l9_58=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_59;
if (l9_58<Port_Position1_N031)
{
l9_59=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_58/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_60;
if (l9_58<Port_Position2_N031)
{
l9_60=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_58-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_61;
if (l9_58<Port_Position3_N031)
{
l9_61=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_58-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_61=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_58-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_60=l9_61;
}
l9_59=l9_60;
}
vec3 l9_62=l9_2*Port_Import_N041;
float l9_63=dot(l9_62,l9_62);
float l9_64;
if (l9_63>0.0)
{
l9_64=1.0/sqrt(l9_63);
}
else
{
l9_64=0.0;
}
vec3 l9_65=l9_62*l9_64;
vec3 l9_66=((sc_ViewMatrixArray[sc_GetStereoViewIndex()]*vec4(l9_65,0.0)).xyz*vec3(Port_Input1_N045))+vec3(Port_Input2_N045);
int l9_67;
...
#endif
float l9_68=l9_66.x;
sc_SoftwareWrapEarly(l9_68,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x);
float l9_69=l9_68;
float l9_70=l9_66.y;
sc_SoftwareWrapEarly(l9_70,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y);
float l9_71=l9_70;
vec2 l9_72;
float l9_73;
...
{
l9_74=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x==3;
}
#else
{
l9_74=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_75=l9_69;
float l9_76=1.0;
sc_ClampUV(l9_75,capsule_btn_refl_tex_1UvMinMax.x,capsule_btn_refl_tex_1UvMinMax.z,l9_74,l9_76);
float l9_77=l9_75;
float l9_78=l9_76;
bool l9_79;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_79=ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y==3;
}
#else
{
l9_79=(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0);
}
#endif
float l9_80=l9_71;
float l9_81=l9_78;
sc_ClampUV(l9_80,capsule_btn_refl_tex_1UvMinMax.y,capsule_btn_refl_tex_1UvMinMax.w,l9_79,l9_81);
l9_73=l9_81;
...
#endif
vec2 l9_82=sc_TransformUV(l9_72,(int(SC_USE_UV_TRANSFORM_capsule_btn_refl_tex_1)!=0),capsule_btn_refl_tex_1Transform);
float l9_83=l9_82.x;
float l9_84=l9_73;
sc_SoftwareWrapLate(l9_83,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).x,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_84);
float l9_85=l9_82.y;
float l9_86=l9_84;
sc_SoftwareWrapLate(l9_85,ivec2(SC_SOFTWARE_WRAP_MODE_U_capsule_btn_refl_tex_1,SC_SOFTWARE_WRAP_MODE_V_capsule_btn_refl_tex_1).y,(int(SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)!=0)&&(!(int(SC_USE_UV_MIN_MAX_capsule_btn_refl_tex_1)!=0)),l9_86);
float l9_87=l9_86;
vec3 l9_88=sc_SamplingCoordsViewToGlobal(vec2(l9_83,l9_85),capsule_btn_refl_tex_1Layout,l9_67);
vec4 l9_89=texture2D(capsule_btn_refl_tex_1,l9_88.xy,0.0);
vec4 l9_90;
#if (SC_USE_CLAMP_TO_BORDER_capsule_btn_refl_tex_1)
{
l9_90=mix(capsule_btn_refl_tex_1BorderColor,l9_89,vec4(l9_87));
}
#else
{
l9_90=l9_89;
...
#endif
vec4 l9_91=vec4(Port_Import_N027)*l9_90;
float l9_92=clamp(((l9_91.xy*Port_Input1_N008)+Port_Input2_N008).x,0.0,1.0);
vec4 l9_93;
if (l9_92<Port_Position1_N005)
{
l9_93=mix(Port_Value0_N005,Port_Value1_N005,vec4(clamp(l9_92/Port_Position1_N005,0.0,1.0)));
}
else
{
vec4 l9_94;
if (l9_92<Port_Position2_N005)
{
l9_94=mix(Port_Value1_N005,Port_Value2_N005,vec4(clamp((l9_92-Port_Position1_N005)/(Port_Position2_N005-Port_Position1_N005),0.0,1.0)));
}
else
{
l9_94=mix(Port_Value2_N005,Port_Value3_N005,vec4(clamp((l9_92-Port_Position2_N005)/(1.0-Port_Position2_N005),0.0,1.0)));
}
l9_93=l9_94;
}
vec4 l9_95=mix(l9_93,Port_Input1_N065,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N064)),Port_Exponent_N064),0.0)*Port_Intensity_N064));
vec4 l9_96=l9_59+l9_95;
float l9_97;
if (l9_58<Port_Position1_N016)
{
l9_97=mix(Port_Value0_N016,Port_Value1_N016,clamp(l9_58/Port_Position1_N016,0.0,1.0));
}
else
{
float l9_98;
if (l9_58<Port_Position2_N016)
{
l9_98=mix(Port_Value1_N016,Port_Value2_N016,clamp((l9_58-Port_Position1_N016)/(Port_Position2_N016-Port_Position1_N016),0.0,1.0));
}
else
{
float l9_99;
if (l9_58<Port_Position3_N016)
{
l9_99=mix(Port_Value2_N016,Port_Value3_N016,clamp((l9_58-Port_Position2_N016)/(Port_Position3_N016-Port_Position2_N016),0.0,1.0));
}
else
{
l9_99=mix(Port_Value3_N016,Port_Value4_N016,clamp((l9_58-Port_Position3_N016)/(1.0-Port_Position3_N016),0.0,1.0));
}
l9_98=l9_99;
}
l9_97=l9_98;
}
vec4 l9_100=vec4(l9_96.x,l9_96.y,l9_96.z,vec4(0.0).w);
l9_100.w=l9_97;
vec4 l9_101=l9_57+l9_100;
float l9_102=l9_101.w;
...
{
l9_105=clamp(l9_102*2.0,0.0,1.0);
}
#else
{
float l9_106;
...
{
l9_106=clamp(dot(l9_101.xyz,vec3(l9_102)),0.0,1.0);
}
#else
{
float l9_107;
...
{
l9_108=(1.0-dot(l9_101.xyz,vec3(0.33333001)))*l9_102;
}
#else
{
float l9_109;
...
{
l9_109=(1.0-clamp(dot(l9_101.xyz,vec3(1.0)),0.0,1.0))*l9_102;
}
#else
{
float l9_110;
...
{
l9_110=clamp(dot(l9_101.xyz,vec3(1.0)),0.0,1.0)*l9_102;
}
#else
{
float l9_111;
#if (sc_BlendMode_Add)
{
l9_111=clamp(dot(l9_101.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_112;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_112=clamp(dot(l9_101.xyz,vec3(1.0)),0.0,1.0)*l9_102;
}
#else
{
float l9_113;
...
{
l9_113=dot(l9_101.xyz,vec3(0.33333001))*l9_102;
}
#else
{
float l9_114;
#if (sc_BlendMode_Min)
{
l9_114=1.0-clamp(dot(l9_101.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_115;
#if (sc_BlendMode_Max)
{
l9_115=clamp(dot(l9_101.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_115=1.0;
...
#endif
l9_103=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_101.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_104);
}
#else
{
vec4 l9_116;
...
#endif
l9_118=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_122,sc_ScreenTextureLayout,l9_123).xy,0.0);
}
#endif
vec4 l9_124;
...
{
vec4 l9_125=l9_118;
l9_125.x=l9_118.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_124=l9_125;
}
#else
{
...
#endif
vec3 l9_126=mix(l9_124.xyz,definedBlend(l9_124.xyz,l9_101.xyz).xyz,vec3(l9_102));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_128=vec4(mix(vec3(1.0),l9_101.xyz,vec3(l9_102)),l9_102);
}
#else
{
vec4 l9_129;
...
#endif
l9_129=vec4(l9_101.xyz*l9_130,l9_130);
}
#else
{
l9_129=l9_101;
...
{
l9_133=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_133=vec4(0.0);
...
vec4 l9_135=outputMotionVectorsIfNeeded(varPos,max(l9_134,vec4(0.0)));
...
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_138).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_139=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_138).xy);
...
sc_writeFragData1(vec4(l9_140,packValue(l9_139),packValue(l9_139),packValue(l9_139)));
sc_writeFragData2(vec4(l9_148,packValue(l9_147),packValue(l9_147),packValue(l9_147)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_151).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_156==0)
{
l9_159=texture2D(sc_OITAlpha0,l9_151);
l9_158=texture2D(sc_OITDepthLow0,l9_151);
l9_157=texture2D(sc_OITDepthHigh0,l9_151);
}
else
{
l9_159=vec4(0.0);
...
if (l9_156==1)
{
l9_162=texture2D(sc_OITAlpha1,l9_151);
l9_161=texture2D(sc_OITDepthLow1,l9_151);
l9_160=texture2D(sc_OITDepthHigh1,l9_151);
}
else
{
l9_162=l9_159;
...
vec4 l9_177=texture2D(sc_OITFilteredDepthBoundsTexture,l9_151);
