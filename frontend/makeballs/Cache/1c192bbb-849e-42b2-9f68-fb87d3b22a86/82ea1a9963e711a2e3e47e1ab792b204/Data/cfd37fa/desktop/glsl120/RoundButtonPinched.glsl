...
vec4 l9_34;
if (l9_33<Port_Position1_N030)
{
l9_34=mix(Port_Value0_N030,Port_Value1_N030,vec4(clamp(l9_33/Port_Position1_N030,0.0,1.0)));
}
else
{
l9_34=mix(Port_Value1_N030,Port_Value2_N030,vec4(clamp((l9_33-Port_Position1_N030)/(1.0-Port_Position1_N030),0.0,1.0)));
}
vec4 l9_35=mix(l9_34,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N031)),Port_Exponent_N031),0.0)*Port_Intensity_N031));
float l9_36=l9_35.w;
vec3 l9_37=(l9_32.xyz+Port_Input1_N002)+l9_35.xyz;
...
{
l9_42=clamp(dot(l9_38.xyz,vec3(l9_36)),0.0,1.0);
}
#else
{
float l9_43;
...
{
l9_44=(1.0-dot(l9_38.xyz,vec3(0.33333001)))*l9_36;
}
#else
{
float l9_45;
...
{
l9_45=(1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0))*l9_36;
}
#else
{
float l9_46;
...
{
l9_46=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_36;
}
#else
{
float l9_47;
#if (sc_BlendMode_Add)
{
l9_47=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_48;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_48=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0)*l9_36;
}
#else
{
float l9_49;
...
{
l9_49=dot(l9_38.xyz,vec3(0.33333001))*l9_36;
}
#else
{
float l9_50;
#if (sc_BlendMode_Min)
{
l9_50=1.0-clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_51;
#if (sc_BlendMode_Max)
{
l9_51=clamp(dot(l9_38.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_51=1.0;
...
#endif
l9_39=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_38.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_40);
}
#else
{
vec4 l9_52;
...
#endif
l9_54=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_58,sc_ScreenTextureLayout,l9_59).xy,0.0);
}
#endif
vec4 l9_60;
...
{
vec4 l9_61=l9_54;
l9_61.x=l9_54.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_60=l9_61;
}
#else
{
...
#endif
vec3 l9_62=mix(l9_60.xyz,definedBlend(l9_60.xyz,l9_38.xyz).xyz,vec3(l9_36));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_64=vec4(mix(vec3(1.0),l9_38.xyz,vec3(l9_36)),l9_36);
}
#else
{
vec4 l9_65;
...
#endif
l9_65=vec4(l9_38.xyz*l9_66,l9_66);
}
#else
{
l9_65=l9_38;
