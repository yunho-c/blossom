...
//sampler sampler simple_round_buttonSmpSC 0:30
...
//texture texture2D simple_round_button 0:19:0:30
...
//spec_const bool SC_USE_CLAMP_TO_BORDER_simple_round_button 32
//spec_const bool SC_USE_UV_MIN_MAX_intensityTexture 33
//spec_const bool SC_USE_UV_MIN_MAX_simple_round_button 34
//spec_const bool SC_USE_UV_TRANSFORM_intensityTexture 35
//spec_const bool SC_USE_UV_TRANSFORM_simple_round_button 36
...
//spec_const bool simple_round_buttonHasSwappedViews 69
//spec_const int SC_SOFTWARE_WRAP_MODE_U_intensityTexture 70
//spec_const int SC_SOFTWARE_WRAP_MODE_U_simple_round_button 71
//spec_const int SC_SOFTWARE_WRAP_MODE_V_intensityTexture 72
//spec_const int SC_SOFTWARE_WRAP_MODE_V_simple_round_button 73
...
//spec_const int simple_round_buttonLayout 82
//SG_REFLECTION_END
...
constant bool simple_round_buttonHasSwappedViews [[function_constant(69)]];
...
constant int SC_SOFTWARE_WRAP_MODE_U_simple_round_button [[function_constant(71)]];
...
constant int SC_SOFTWARE_WRAP_MODE_V_simple_round_button [[function_constant(73)]];
...
constant int simple_round_buttonLayout [[function_constant(82)]];
...
int l9_11=l9_10;
VectorOut_N96=((*sc_set0.UserUniforms).sc_ViewMatrixArray[l9_11]*float4(Output_N91,0.0)).xyz;
...
float3x3 param_6=(*sc_set0.UserUniforms).simple_round_buttonTransform;
...
float4 param_9=(*sc_set0.UserUniforms).simple_round_buttonUvMinMax;
bool param_10=(int(SC_USE_CLAMP_TO_BORDER_simple_round_button_tmp)!=0);
float4 param_11=(*sc_set0.UserUniforms).simple_round_buttonBorderColor;
float param_12=0.0;
...
float l9_87=l9_79;
float4 l9_88=sc_set0.simple_round_button.sample(sc_set0.simple_round_buttonSmpSC,l9_86,bias(l9_87));
float4 l9_89=l9_88;
float4 l9_90=l9_89;
if (param_10)
{
...
float4 param_14=(*sc_set0.UserUniforms).Port_Value0_N030;
float param_15=(*sc_set0.UserUniforms).Port_Position1_N030;
float4 param_16=(*sc_set0.UserUniforms).Port_Value1_N030;
float4 param_17=(*sc_set0.UserUniforms).Port_Value2_N030;
...
Value_N30=param_18;
float Rim_N31=0.0;
float3 param_19=(*sc_set0.UserUniforms).Port_Normal_N031;
float param_20=(*sc_set0.UserUniforms).Port_Exponent_N031;
float param_21=(*sc_set0.UserUniforms).Port_Intensity_N031;
...
bool l9_96=(*sc_set0.UserUniforms).isProxyMode!=0;
if (l9_96)
{
...
float l9_101=l9_100;
float l9_102=l9_101;
float l9_103=(*sc_set0.UserUniforms).sc_ShadowDensity*l9_102;
float3 l9_104=mix((*sc_set0.UserUniforms).sc_ShadowColor.xyz,(*sc_set0.UserUniforms).sc_ShadowColor.xyz*l9_98.xyz,float3((*sc_set0.UserUniforms).sc_ShadowColor.w));
...
{
l9_110.x+=(*sc_set0.UserUniforms)._sc_framebufferFetchMarker;
}
...
float l9_150=l9_142;
float4 l9_151=sc_set0.sc_ScreenTexture.sample(sc_set0.sc_ScreenTextureSmpSC,l9_149,bias(l9_150));
float4 l9_152=l9_151;
l9_138=l9_152;
...
{
l9_169=float4((*sc_set0.UserUniforms).shaderComplexityValue/255.0,0.0,0.0,1.0);
}
else
{
l9_169=float4(0.0);
...
if (sc_ShaderCacheConstant_tmp!=0)
{
l9_171.x+=((*sc_set0.UserUniforms).sc_UniformConstants.x*float(sc_ShaderCacheConstant_tmp));
}
