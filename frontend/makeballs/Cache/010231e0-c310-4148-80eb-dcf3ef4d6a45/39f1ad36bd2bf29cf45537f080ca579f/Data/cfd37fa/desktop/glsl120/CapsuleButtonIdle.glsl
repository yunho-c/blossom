...
vec4 l9_89;
if (l9_88<Port_Position1_N007)
{
l9_89=mix(Port_Value0_N007,Port_Value1_N007,vec4(clamp(l9_88/Port_Position1_N007,0.0,1.0)));
}
else
{
vec4 l9_90;
if (l9_88<Port_Position2_N007)
{
l9_90=mix(Port_Value1_N007,Port_Value2_N007,vec4(clamp((l9_88-Port_Position1_N007)/(Port_Position2_N007-Port_Position1_N007),0.0,1.0)));
}
else
{
vec4 l9_91;
if (l9_88<Port_Position3_N007)
{
l9_91=mix(Port_Value2_N007,Port_Value3_N007,vec4(clamp((l9_88-Port_Position2_N007)/(Port_Position3_N007-Port_Position2_N007),0.0,1.0)));
}
else
{
l9_91=mix(Port_Value3_N007,Port_Value4_N007,vec4(clamp((l9_88-Port_Position3_N007)/(1.0-Port_Position3_N007),0.0,1.0)));
}
l9_90=l9_91;
}
l9_89=l9_90;
}
float l9_92=clamp(length((varPackedTex.xy*Port_Input1_N028)+Port_Input2_N028),0.0,1.0);
vec4 l9_93;
if (l9_92<Port_Position1_N031)
{
l9_93=mix(Port_Value0_N031,Port_Value1_N031,vec4(clamp(l9_92/Port_Position1_N031,0.0,1.0)));
}
else
{
vec4 l9_94;
if (l9_92<Port_Position2_N031)
{
l9_94=mix(Port_Value1_N031,Port_Value2_N031,vec4(clamp((l9_92-Port_Position1_N031)/(Port_Position2_N031-Port_Position1_N031),0.0,1.0)));
}
else
{
vec4 l9_95;
if (l9_92<Port_Position3_N031)
{
l9_95=mix(Port_Value2_N031,Port_Value3_N031,vec4(clamp((l9_92-Port_Position2_N031)/(Port_Position3_N031-Port_Position2_N031),0.0,1.0)));
}
else
{
l9_95=mix(Port_Value3_N031,Port_Value4_N031,vec4(clamp((l9_92-Port_Position3_N031)/(1.0-Port_Position3_N031),0.0,1.0)));
}
l9_94=l9_95;
}
l9_93=l9_94;
}
vec4 l9_96=mix(l9_89,l9_93,l9_93);
float l9_97=clamp(l9_89.x,0.0,1.0);
float l9_98;
if (l9_97<Port_Position1_N011)
{
l9_98=mix(Port_Value0_N011,Port_Value1_N011,clamp(l9_97/Port_Position1_N011,0.0,1.0));
}
else
{
float l9_99;
if (l9_97<Port_Position2_N011)
{
l9_99=mix(Port_Value1_N011,Port_Value2_N011,clamp((l9_97-Port_Position1_N011)/(Port_Position2_N011-Port_Position1_N011),0.0,1.0));
}
else
{
float l9_100;
if (l9_97<Port_Position3_N011)
{
l9_100=mix(Port_Value2_N011,Port_Value3_N011,clamp((l9_97-Port_Position2_N011)/(Port_Position3_N011-Port_Position2_N011),0.0,1.0));
}
else
{
l9_100=mix(Port_Value3_N011,Port_Value4_N011,clamp((l9_97-Port_Position3_N011)/(1.0-Port_Position3_N011),0.0,1.0));
}
l9_99=l9_100;
}
l9_98=l9_99;
}
vec4 l9_101=vec4(l9_96.x,l9_96.y,l9_96.z,vec4(0.0).w);
l9_101.w=l9_98;
vec4 l9_102=l9_57+l9_101;
float l9_103=l9_102.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_103<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_103<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_106=clamp(l9_103*2.0,0.0,1.0);
}
#else
{
float l9_107;
...
{
l9_107=clamp(dot(l9_102.xyz,vec3(l9_103)),0.0,1.0);
}
#else
{
float l9_108;
...
{
l9_109=(1.0-dot(l9_102.xyz,vec3(0.33333001)))*l9_103;
}
#else
{
float l9_110;
...
{
l9_110=(1.0-clamp(dot(l9_102.xyz,vec3(1.0)),0.0,1.0))*l9_103;
}
#else
{
float l9_111;
...
{
l9_111=clamp(dot(l9_102.xyz,vec3(1.0)),0.0,1.0)*l9_103;
}
#else
{
float l9_112;
#if (sc_BlendMode_Add)
{
l9_112=clamp(dot(l9_102.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_113;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_113=clamp(dot(l9_102.xyz,vec3(1.0)),0.0,1.0)*l9_103;
}
#else
{
float l9_114;
...
{
l9_114=dot(l9_102.xyz,vec3(0.33333001))*l9_103;
}
#else
{
float l9_115;
#if (sc_BlendMode_Min)
{
l9_115=1.0-clamp(dot(l9_102.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_116;
#if (sc_BlendMode_Max)
{
l9_116=clamp(dot(l9_102.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_116=1.0;
...
#endif
l9_104=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_102.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_105);
}
#else
{
vec4 l9_117;
...
#endif
vec3 l9_127=mix(l9_125.xyz,definedBlend(l9_125.xyz,l9_102.xyz).xyz,vec3(l9_103));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_129=vec4(mix(vec3(1.0),l9_102.xyz,vec3(l9_103)),l9_103);
}
#else
{
vec4 l9_130;
...
#endif
l9_130=vec4(l9_102.xyz*l9_131,l9_131);
}
#else
{
l9_130=l9_102;
