...
float l9_74=l9_73*max(smoothstep(blur,blur*Port_Input1_N098,length(max(abs(varPackedTex.xy-Port_Input1_N085)-(boxSize-vec2(cornerRadius)),Port_Input1_N089))-cornerRadius),Port_Input1_N094);
vec4 l9_75=vec4(l9_39.x,l9_39.y,l9_39.z,vec4(0.0).w);
l9_75.w=l9_74;
vec3 l9_76=smoothstep(Port_Input0_N073,Port_Input1_N073,vec3(distance(Port_Input0_N042,(varPackedTex.xy-Port_Input1_N046)*vec2(Port_Input1_N047))));
float l9_77=l9_1*Port_Multiplier_N054;
float l9_78=sin(l9_77);
float l9_79=(max(((l9_78*Port_Input1_N078)*l9_78)*Port_Input1_N080,Port_Input1_N079)*Port_Input1_N057)+Port_Input1_N070;
float l9_80=l9_76.x;
float l9_81;
if (l9_80<=0.0)
{
...
{
l9_85=pow(l9_84,l9_79);
}
vec3 l9_86=mix(vec3(l9_81,l9_83,l9_85),vec3(floor(fract(sin(floor(dot(floor((floor(varPackedTex.xy*10000.0)*9.9999997e-05)*Port_Scale_N081),vec2(0.98000002,0.72000003))*10000.0)*9.9999997e-05)*437.58499)*10000.0)*9.9999997e-05),vec3(Port_Input2_N082));
vec4 l9_87=vec4(l9_86.x,l9_86.y,l9_86.z,vec4(0.0).w);
l9_87.w=l9_74;
vec4 l9_88=mix(l9_75,l9_87,vec4(Port_Input2_N045));
if ((step(l9_74,Port_Input1_N099)*1.0)!=0.0)
{
discard;
}
float l9_89=l9_88.w;
...
{
if (l9_89<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_93=clamp(dot(l9_88.xyz,vec3(l9_89)),0.0,1.0);
}
#else
{
float l9_94;
...
{
l9_95=(1.0-dot(l9_88.xyz,vec3(0.33333001)))*l9_89;
}
#else
{
float l9_96;
...
{
l9_96=(1.0-clamp(dot(l9_88.xyz,vec3(1.0)),0.0,1.0))*l9_89;
}
#else
{
float l9_97;
...
{
l9_97=clamp(dot(l9_88.xyz,vec3(1.0)),0.0,1.0)*l9_89;
}
#else
{
float l9_98;
#if (sc_BlendMode_Add)
{
l9_98=clamp(dot(l9_88.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_99;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_99=clamp(dot(l9_88.xyz,vec3(1.0)),0.0,1.0)*l9_89;
}
#else
{
float l9_100;
...
{
l9_100=dot(l9_88.xyz,vec3(0.33333001))*l9_89;
}
#else
{
float l9_101;
#if (sc_BlendMode_Min)
{
l9_101=1.0-clamp(dot(l9_88.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_102;
#if (sc_BlendMode_Max)
{
l9_102=clamp(dot(l9_88.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_102=1.0;
...
#endif
l9_90=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_88.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_91);
}
#else
{
vec4 l9_103;
...
#if (sc_FramebufferFetch)
{
vec4 l9_106=sc_readFragData0_Platform();
vec4 l9_107;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_108=l9_106;
l9_108.x=l9_106.x+_sc_framebufferFetchMarker;
l9_107=l9_108;
}
#else
{
...
#else
{
vec2 l9_109=sc_ScreenCoordsGlobalToView(l9_3);
int l9_110;
...
#endif
l9_105=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_109,sc_ScreenTextureLayout,l9_110).xy,0.0);
}
#endif
vec4 l9_111;
...
{
vec4 l9_112=l9_105;
l9_112.x=l9_105.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_111=l9_112;
}
#else
{
...
#endif
vec3 l9_113=mix(l9_111.xyz,definedBlend(l9_111.xyz,l9_88.xyz).xyz,vec3(l9_89));
vec4 l9_114=vec4(l9_113.x,l9_113.y,l9_113.z,vec4(0.0).w);
l9_114.w=1.0;
l9_104=l9_114;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_115=vec4(mix(vec3(1.0),l9_88.xyz,vec3(l9_89)),l9_89);
}
#else
{
vec4 l9_116;
...
#endif
l9_116=vec4(l9_88.xyz*l9_117,l9_117);
}
#else
{
l9_116=l9_88;
...
{
l9_120=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_120=vec4(0.0);
...
vec4 l9_122=outputMotionVectorsIfNeeded(varPos,max(l9_121,vec4(0.0)));
vec4 l9_123=clamp(l9_122,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_124=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_124-0.0039215689)),min(1.0,l9_124+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_125=sc_ScreenCoordsGlobalToView(l9_3);
...
#endif
int l9_126=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_125).xy);
float l9_127=packValue(l9_126);
int l9_134=int(l9_123.w*255.0);
float l9_135=packValue(l9_134);
sc_writeFragData0(vec4(packValue(l9_126),packValue(l9_126),packValue(l9_126),packValue(l9_126)));
sc_writeFragData1(vec4(l9_127,packValue(l9_126),packValue(l9_126),packValue(l9_126)));
sc_writeFragData2(vec4(l9_135,packValue(l9_134),packValue(l9_134),packValue(l9_134)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_138=sc_ScreenCoordsGlobalToView(l9_3);
#if (sc_OITMaxLayers4Plus1)
{
...
if (l9_143==0)
{
l9_146=texture2D(sc_OITAlpha0,l9_138);
l9_145=texture2D(sc_OITDepthLow0,l9_138);
l9_144=texture2D(sc_OITDepthHigh0,l9_138);
}
else
{
l9_146=vec4(0.0);
...
if (l9_143==1)
{
l9_149=texture2D(sc_OITAlpha1,l9_138);
l9_148=texture2D(sc_OITDepthLow1,l9_138);
l9_147=texture2D(sc_OITDepthHigh1,l9_138);
}
else
{
l9_149=l9_146;
...
if (any(notEqual(l9_147,vec4(0.0)))||any(notEqual(l9_148,vec4(0.0))))
{
int l9_150[8]=l9_139;
unpackValues(l9_147.w,l9_143,l9_150);
unpackValues(l9_147.z,l9_143,l9_150);
unpackValues(l9_147.y,l9_143,l9_150);
unpackValues(l9_147.x,l9_143,l9_150);
unpackValues(l9_148.w,l9_143,l9_150);
unpackValues(l9_148.z,l9_143,l9_150);
unpackValues(l9_148.y,l9_143,l9_150);
unpackValues(l9_148.x,l9_143,l9_150);
int l9_159[8]=l9_140;
unpackValues(l9_149.w,l9_143,l9_159);
unpackValues(l9_149.z,l9_143,l9_159);
unpackValues(l9_149.y,l9_143,l9_159);
unpackValues(l9_149.x,l9_143,l9_159);
}
l9_143++;
continue;
}
...
vec4 l9_164=texture2D(sc_OITFilteredDepthBoundsTexture,l9_138);
vec2 l9_165=l9_164.xy;
int l9_166;
#if (sc_SkinBonesCount>0)
{
l9_166=encodeDepth(((1.0-l9_164.x)*1000.0)+getDepthOrderingEpsilon(),l9_165);
}
#else
{
l9_166=0;
...
#endif
int l9_167=encodeDepth(viewSpaceDepth(),l9_165);
vec4 l9_168;
l9_168=l9_123*l9_123.w;
vec4 l9_169;
int l9_170=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_170<8)
{
int l9_171=l9_139[l9_170];
int l9_172=l9_167-l9_166;
bool l9_173=l9_171<l9_172;
bool l9_174;
if (l9_173)
{
l9_174=l9_139[l9_170]>0;
}
else
{
l9_174=l9_173;
...
if (l9_174)
{
vec3 l9_175=l9_168.xyz*(1.0-(float(l9_140[l9_170])/255.0));
l9_169=vec4(l9_175.x,l9_175.y,l9_175.z,l9_168.w);
}
else
{
l9_169=l9_168;
