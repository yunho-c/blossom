...
#endif
float l9_50=l9_48.x;
sc_SoftwareWrapEarly(l9_50,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x);
float l9_51=l9_50;
float l9_52=l9_48.y;
sc_SoftwareWrapEarly(l9_52,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y);
float l9_53=l9_52;
vec2 l9_54;
float l9_55;
...
{
l9_56=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x==3;
}
#else
{
l9_56=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_57=l9_51;
float l9_58=1.0;
sc_ClampUV(l9_57,matcapTextureUvMinMax.x,matcapTextureUvMinMax.z,l9_56,l9_58);
float l9_59=l9_57;
float l9_60=l9_58;
bool l9_61;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_61=ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y==3;
}
#else
{
l9_61=(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0);
}
#endif
float l9_62=l9_53;
float l9_63=l9_60;
sc_ClampUV(l9_62,matcapTextureUvMinMax.y,matcapTextureUvMinMax.w,l9_61,l9_63);
l9_55=l9_63;
...
#endif
vec2 l9_64=sc_TransformUV(l9_54,(int(SC_USE_UV_TRANSFORM_matcapTexture)!=0),matcapTextureTransform);
float l9_65=l9_64.x;
float l9_66=l9_55;
sc_SoftwareWrapLate(l9_65,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).x,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0)),l9_66);
float l9_67=l9_64.y;
float l9_68=l9_66;
sc_SoftwareWrapLate(l9_67,ivec2(SC_SOFTWARE_WRAP_MODE_U_matcapTexture,SC_SOFTWARE_WRAP_MODE_V_matcapTexture).y,(int(SC_USE_CLAMP_TO_BORDER_matcapTexture)!=0)&&(!(int(SC_USE_UV_MIN_MAX_matcapTexture)!=0)),l9_68);
float l9_69=l9_68;
vec3 l9_70=sc_SamplingCoordsViewToGlobal(vec2(l9_65,l9_67),matcapTextureLayout,l9_49);
vec4 l9_71=texture2D(matcapTexture,l9_70.xy,0.0);
vec4 l9_72;
#if (SC_USE_CLAMP_TO_BORDER_matcapTexture)
{
l9_72=mix(matcapTextureBorderColor,l9_71,vec4(l9_69));
}
#else
{
l9_72=l9_71;
...
{
l9_73=pow(l9_44,Port_Input1_N087);
}
vec4 l9_74=vec4(l9_73);
vec4 l9_75=max(l9_45,mix(Port_Input0_N024,Port_Input1_N024,l9_74));
float l9_76=borderAlpha*l9_44;
float l9_77;
if (l9_32<=0.0)
{
l9_77=0.0;
...
{
l9_77=pow(l9_32,(((borderAlpha-Port_RangeMinA_N129)/(Port_RangeMaxA_N129-Port_RangeMinA_N129))*(Port_RangeMaxB_N129-Port_RangeMinB_N129))+Port_RangeMinB_N129);
}
float l9_78=(backingAlpha*Port_Input1_N052)*l9_77;
float l9_79=(isHovered*smoothstep(Port_Input0_N166*l9_2,Port_Input1_N165,l9_16))*smoothstep(Port_Input0_N157,Port_Input1_N157,(clamp(smoothstep((-Port_handleWidth_N104)*0.5,0.0,l9_33),0.0,1.0)-clamp(smoothstep(0.0,Port_handleWidth_N104*0.5,l9_33),0.0,1.0))*((((0.0+((l9_36*l9_39)*scaleHandles.x))+((l9_41*l9_39)*scaleHandles.y))+((l9_41*l9_43)*scaleHandles.z))+((l9_36*l9_43)*scaleHandles.w)));
vec4 l9_80=vec4(Port_Value1_N156.x,Port_Value1_N156.y,Port_Value1_N156.z,vec4(0.0).w);
l9_80.w=l9_79;
vec4 l9_81=mix(vec4((Port_Value_N151.xyz*l9_78)+((l9_75*vec4(Port_Input1_N149)).xyz*l9_76),max(l9_78,l9_76)),l9_80,vec4(l9_79));
vec3 l9_82=mix(Port_Input0_N055,mix(Port_Value_N073,Port_Value_N054,l9_21),vec3(l9_25))+l9_81.xyz;
float l9_83=(l9_81.w*opacity)*max(Port_Input0_N107-cutOutCenter,smoothstep(Port_Input0_N106,Port_Input0_N091/l9_1,length(max(abs(l9_12)-vec2(Port_Input1_N085),Port_Input1_N102)/l9_15)));
vec4 l9_84=vec4(l9_82.x,l9_82.y,l9_82.z,vec4(0.0).w);
l9_84.w=l9_83;
if ((step(l9_83,Port_Input1_N093)*1.0)!=0.0)
{
discard;
}
...
#if (sc_FramebufferFetch)
{
vec4 l9_101=sc_readFragData0_Platform();
vec4 l9_102;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_103=l9_101;
l9_103.x=l9_101.x+_sc_framebufferFetchMarker;
l9_102=l9_103;
}
#else
{
...
#endif
l9_100=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_104,sc_ScreenTextureLayout,l9_105).xy,0.0);
}
#endif
vec4 l9_106;
...
{
vec4 l9_107=l9_100;
l9_107.x=l9_100.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_106=l9_107;
}
#else
{
...
#endif
vec3 l9_108=mix(l9_106.xyz,definedBlend(l9_106.xyz,l9_84.xyz).xyz,vec3(l9_83));
vec4 l9_109=vec4(l9_108.x,l9_108.y,l9_108.z,vec4(0.0).w);
l9_109.w=1.0;
l9_99=l9_109;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_110=vec4(mix(vec3(1.0),l9_84.xyz,vec3(l9_83)),l9_83);
}
#else
{
vec4 l9_111;
...
#endif
l9_111=vec4(l9_84.xyz*l9_112,l9_112);
}
#else
{
l9_111=l9_84;
...
{
l9_115=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_115=vec4(0.0);
...
vec4 l9_117=outputMotionVectorsIfNeeded(varPos,max(l9_116,vec4(0.0)));
...
sc_writeFragData0(vec4(max(0.0,1.0-(l9_119-0.0039215689)),min(1.0,l9_119+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
sc_writeFragData0(vec4(packValue(l9_121),packValue(l9_121),packValue(l9_121),packValue(l9_121)));
