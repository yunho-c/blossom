...
#endif
float l9_46=(mix(baseColor,SecondGradient,vec4(varPackedTex.y))*l9_13).w*l9_14;
...
vec4 l9_238=l9_237*vec4(colorMultiplier+1.0);
float l9_239=l9_237.w;
vec4 l9_240=vec4(l9_238.x,l9_238.y,l9_238.z,vec4(0.0).w);
l9_240.w=l9_239;
vec4 l9_241;
#if (sc_ProjectiveShadowsCaster)
{
...
#if (sc_BlendMode_PremultipliedAlpha)
{
l9_243=clamp(l9_239*2.0,0.0,1.0);
}
#else
{
float l9_244;
...
{
l9_244=clamp(dot(l9_240.xyz,vec3(l9_239)),0.0,1.0);
}
#else
{
float l9_245;
...
#if (sc_BlendMode_Multiply)
{
l9_246=(1.0-dot(l9_240.xyz,vec3(0.33333001)))*l9_239;
}
#else
{
float l9_247;
...
{
l9_247=(1.0-clamp(dot(l9_240.xyz,vec3(1.0)),0.0,1.0))*l9_239;
}
#else
{
float l9_248;
#if (sc_BlendMode_ColoredGlass)
{
l9_248=clamp(dot(l9_240.xyz,vec3(1.0)),0.0,1.0)*l9_239;
}
#else
{
float l9_249;
#if (sc_BlendMode_Add)
{
l9_249=clamp(dot(l9_240.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_250;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_250=clamp(dot(l9_240.xyz,vec3(1.0)),0.0,1.0)*l9_239;
}
#else
{
float l9_251;
...
{
l9_251=dot(l9_240.xyz,vec3(0.33333001))*l9_239;
}
#else
{
float l9_252;
#if (sc_BlendMode_Min)
{
l9_252=1.0-clamp(dot(l9_240.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_253;
#if (sc_BlendMode_Max)
{
l9_253=clamp(dot(l9_240.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_253=1.0;
...
#endif
l9_241=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_240.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_242);
}
#else
{
vec4 l9_254;
...
{
vec3 l9_256=sc_GetFramebufferColor().xyz;
vec3 l9_257=mix(l9_256,definedBlend(l9_256,l9_240.xyz).xyz,vec3(l9_239));
vec4 l9_258=vec4(l9_257.x,l9_257.y,l9_257.z,vec4(0.0).w);
l9_258.w=1.0;
l9_255=l9_258;
}
#else
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_259=vec4(mix(vec3(1.0),l9_240.xyz,vec3(l9_239)),l9_239);
}
#else
{
vec4 l9_260;
...
#endif
l9_260=vec4(l9_240.xyz*l9_261,l9_261);
}
#else
{
l9_260=l9_240;
...
{
l9_264=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_264=vec4(0.0);
...
vec4 l9_266=outputMotionVectorsIfNeeded(varPos,max(l9_265,vec4(0.0)));
vec4 l9_267=clamp(l9_266,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_268=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_268-0.0039215689)),min(1.0,l9_268+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#if (sc_OITDepthGatherPass)
{
vec2 l9_269=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_269).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
#endif
int l9_270=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_269).xy);
float l9_271=packValue(l9_270);
int l9_278=int(l9_267.w*255.0);
float l9_279=packValue(l9_278);
sc_writeFragData0(vec4(packValue(l9_270),packValue(l9_270),packValue(l9_270),packValue(l9_270)));
sc_writeFragData1(vec4(l9_271,packValue(l9_270),packValue(l9_270),packValue(l9_270)));
sc_writeFragData2(vec4(l9_279,packValue(l9_278),packValue(l9_278),packValue(l9_278)));
...
#if (sc_OITCompositingPass)
{
vec2 l9_282=sc_ScreenCoordsGlobalToView(l9_4);
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_282).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_287==0)
{
l9_290=texture2D(sc_OITAlpha0,l9_282);
l9_289=texture2D(sc_OITDepthLow0,l9_282);
l9_288=texture2D(sc_OITDepthHigh0,l9_282);
}
else
{
l9_290=vec4(0.0);
...
if (l9_287==1)
{
l9_293=texture2D(sc_OITAlpha1,l9_282);
l9_292=texture2D(sc_OITDepthLow1,l9_282);
l9_291=texture2D(sc_OITDepthHigh1,l9_282);
}
else
{
l9_293=l9_290;
...
if (any(notEqual(l9_291,vec4(0.0)))||any(notEqual(l9_292,vec4(0.0))))
{
int l9_294[8]=l9_283;
unpackValues(l9_291.w,l9_287,l9_294);
unpackValues(l9_291.z,l9_287,l9_294);
unpackValues(l9_291.y,l9_287,l9_294);
unpackValues(l9_291.x,l9_287,l9_294);
unpackValues(l9_292.w,l9_287,l9_294);
unpackValues(l9_292.z,l9_287,l9_294);
unpackValues(l9_292.y,l9_287,l9_294);
unpackValues(l9_292.x,l9_287,l9_294);
int l9_303[8]=l9_284;
unpackValues(l9_293.w,l9_287,l9_303);
unpackValues(l9_293.z,l9_287,l9_303);
unpackValues(l9_293.y,l9_287,l9_303);
unpackValues(l9_293.x,l9_287,l9_303);
}
l9_287++;
continue;
}
...
vec4 l9_308=texture2D(sc_OITFilteredDepthBoundsTexture,l9_282);
vec2 l9_309=l9_308.xy;
int l9_310;
#if (sc_SkinBonesCount>0)
{
l9_310=encodeDepth(((1.0-l9_308.x)*1000.0)+getDepthOrderingEpsilon(),l9_309);
}
#else
{
l9_310=0;
...
#endif
int l9_311=encodeDepth(viewSpaceDepth(),l9_309);
vec4 l9_312;
l9_312=l9_267*l9_267.w;
vec4 l9_313;
int l9_314=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_314<8)
{
int l9_315=l9_283[l9_314];
int l9_316=l9_311-l9_310;
bool l9_317=l9_315<l9_316;
bool l9_318;
if (l9_317)
{
l9_318=l9_283[l9_314]>0;
}
else
{
l9_318=l9_317;
...
if (l9_318)
{
vec3 l9_319=l9_312.xyz*(1.0-(float(l9_284[l9_314])/255.0));
l9_313=vec4(l9_319.x,l9_319.y,l9_319.z,l9_312.w);
}
else
{
l9_313=l9_312;
