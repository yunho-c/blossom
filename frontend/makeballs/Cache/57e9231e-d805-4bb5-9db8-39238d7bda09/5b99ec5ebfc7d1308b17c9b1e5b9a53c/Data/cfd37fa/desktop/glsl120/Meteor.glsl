...
{
if (l9_23.w<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_26=clamp(l9_23.w*2.0,0.0,1.0);
}
#else
{
float l9_27;
...
{
l9_27=clamp(dot(l9_23.xyz,vec3(l9_23.w)),0.0,1.0);
}
#else
{
float l9_28;
...
{
l9_29=(1.0-dot(l9_23.xyz,vec3(0.33333001)))*l9_23.w;
}
#else
{
float l9_30;
...
{
l9_30=(1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0))*l9_23.w;
}
#else
{
float l9_31;
...
{
l9_31=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*l9_23.w;
}
#else
{
float l9_32;
#if (sc_BlendMode_Add)
{
l9_32=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_33;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_33=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0)*l9_23.w;
}
#else
{
float l9_34;
...
{
l9_34=dot(l9_23.xyz,vec3(0.33333001))*l9_23.w;
}
#else
{
float l9_35;
#if (sc_BlendMode_Min)
{
l9_35=1.0-clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_36;
#if (sc_BlendMode_Max)
{
l9_36=clamp(dot(l9_23.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_36=1.0;
...
#endif
l9_24=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_23.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_25);
}
#else
{
vec4 l9_37;
...
#endif
l9_39=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_43,sc_ScreenTextureLayout,l9_44).xy,0.0);
}
#endif
vec4 l9_45;
...
#endif
vec3 l9_47=mix(l9_45.xyz,definedBlend(l9_45.xyz,l9_23.xyz).xyz,vec3(l9_23.w));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_49=vec4(mix(vec3(1.0),l9_23.xyz,vec3(l9_23.w)),l9_23.w);
}
#else
{
vec4 l9_50;
...
#endif
l9_50=vec4(l9_23.xyz*l9_51,l9_51);
}
#else
{
l9_50=l9_23;
