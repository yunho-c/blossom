...
float3x3 param_4=(*sc_set0.UserUniforms).mainTexTransform;
...
float4 param_7=(*sc_set0.UserUniforms).mainTexUvMinMax;
bool param_8=(int(SC_USE_CLAMP_TO_BORDER_mainTex_tmp)!=0);
float4 param_9=(*sc_set0.UserUniforms).mainTexBorderColor;
float param_10=0.0;
...
float4 param_11=(*sc_set0.UserUniforms).glowColor;
Output_N3=param_11;
...
float param_13=(*sc_set0.UserUniforms).pinchBrightness;
Output_N13=param_13;
float Output_N14=0.0;
float param_14=(*sc_set0.UserUniforms).pokeBrightness;
Output_N14=param_14;
