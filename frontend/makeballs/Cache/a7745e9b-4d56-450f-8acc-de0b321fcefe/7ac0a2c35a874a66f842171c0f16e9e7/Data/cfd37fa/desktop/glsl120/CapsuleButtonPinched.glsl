...
float l9_88=clamp(l9_87.x,0.0,1.0);
vec4 l9_89;
if (l9_88<Port_Position1_N067)
{
l9_89=mix(Port_Value0_N067,Port_Value1_N067,vec4(clamp(l9_88/Port_Position1_N067,0.0,1.0)));
}
else
{
vec4 l9_90;
if (l9_88<Port_Position2_N067)
{
l9_90=mix(Port_Value1_N067,Port_Value2_N067,vec4(clamp((l9_88-Port_Position1_N067)/(Port_Position2_N067-Port_Position1_N067),0.0,1.0)));
}
else
{
vec4 l9_91;
if (l9_88<Port_Position3_N067)
{
l9_91=mix(Port_Value2_N067,Port_Value3_N067,vec4(clamp((l9_88-Port_Position2_N067)/(Port_Position3_N067-Port_Position2_N067),0.0,1.0)));
}
else
{
l9_91=mix(Port_Value3_N067,Port_Value4_N067,vec4(clamp((l9_88-Port_Position3_N067)/(1.0-Port_Position3_N067),0.0,1.0)));
}
l9_90=l9_91;
}
l9_89=l9_90;
}
vec4 l9_92=mix(l9_89,Port_Input1_N034,vec4(max(pow(1.0-abs(dot(-normalize(sc_Camera.position-varPos),l9_2*Port_Normal_N023)),Port_Exponent_N023),0.0)*Port_Intensity_N023));
vec4 l9_93=l9_57+l9_92;
float l9_94=l9_93.w;
#if (sc_BlendMode_AlphaTest)
{
if (l9_94<alphaTestThreshold)
{
discard;
}
}
...
{
if (l9_94<((mod(dot(floor(mod(gl_FragCoord.xy,vec2(4.0))),vec2(4.0,1.0))*9.0,16.0)+1.0)/17.0))
{
discard;
}
}
...
{
l9_98=clamp(dot(l9_93.xyz,vec3(l9_94)),0.0,1.0);
}
#else
{
float l9_99;
...
{
l9_100=(1.0-dot(l9_93.xyz,vec3(0.33333001)))*l9_94;
}
#else
{
float l9_101;
...
{
l9_101=(1.0-clamp(dot(l9_93.xyz,vec3(1.0)),0.0,1.0))*l9_94;
}
#else
{
float l9_102;
...
{
l9_102=clamp(dot(l9_93.xyz,vec3(1.0)),0.0,1.0)*l9_94;
}
#else
{
float l9_103;
#if (sc_BlendMode_Add)
{
l9_103=clamp(dot(l9_93.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_104;
#if (sc_BlendMode_AddWithAlphaFactor)
{
l9_104=clamp(dot(l9_93.xyz,vec3(1.0)),0.0,1.0)*l9_94;
}
#else
{
float l9_105;
...
{
l9_105=dot(l9_93.xyz,vec3(0.33333001))*l9_94;
}
#else
{
float l9_106;
#if (sc_BlendMode_Min)
{
l9_106=1.0-clamp(dot(l9_93.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
float l9_107;
#if (sc_BlendMode_Max)
{
l9_107=clamp(dot(l9_93.xyz,vec3(1.0)),0.0,1.0);
}
#else
{
l9_107=1.0;
...
#endif
l9_95=vec4(mix(sc_ShadowColor.xyz,sc_ShadowColor.xyz*l9_93.xyz,vec3(sc_ShadowColor.w)),sc_ShadowDensity*l9_96);
}
#else
{
vec4 l9_108;
...
#if (sc_FramebufferFetch)
{
vec4 l9_111=sc_readFragData0_Platform();
vec4 l9_112;
#if (sc_UseFramebufferFetchMarker)
{
vec4 l9_113=l9_111;
l9_113.x=l9_111.x+_sc_framebufferFetchMarker;
l9_112=l9_113;
}
#else
{
...
{
l9_115=1-sc_GetStereoViewIndex();
}
#else
{
l9_115=sc_GetStereoViewIndex();
}
#endif
l9_110=texture2D(sc_ScreenTexture,sc_SamplingCoordsViewToGlobal(l9_114,sc_ScreenTextureLayout,l9_115).xy,0.0);
}
#endif
vec4 l9_116;
...
{
vec4 l9_117=l9_110;
l9_117.x=l9_110.x+_sc_GetFramebufferColorInvalidUsageMarker;
l9_116=l9_117;
}
#else
{
...
#endif
vec3 l9_118=mix(l9_116.xyz,definedBlend(l9_116.xyz,l9_93.xyz).xyz,vec3(l9_94));
...
#if (sc_BlendMode_MultiplyOriginal)
{
l9_120=vec4(mix(vec3(1.0),l9_93.xyz,vec3(l9_94)),l9_94);
}
#else
{
vec4 l9_121;
...
#endif
l9_121=vec4(l9_93.xyz*l9_122,l9_122);
}
#else
{
l9_121=l9_93;
...
{
l9_125=vec4(shaderComplexityValue/255.0,0.0,0.0,1.0);
}
#else
{
l9_125=vec4(0.0);
...
vec4 l9_127=outputMotionVectorsIfNeeded(varPos,max(l9_126,vec4(0.0)));
vec4 l9_128=clamp(l9_127,vec4(0.0),vec4(1.0));
#if (sc_OITDepthBoundsPass)
{
#if (sc_OITDepthBoundsPass)
{
float l9_129=clamp(viewSpaceDepth()/1000.0,0.0,1.0);
sc_writeFragData0(vec4(max(0.0,1.0-(l9_129-0.0039215689)),min(1.0,l9_129+0.0039215689),0.0,0.0));
}
#endif
}
#else
...
#endif
int l9_131=encodeDepth(viewSpaceDepth(),texture2D(sc_OITFilteredDepthBoundsTexture,l9_130).xy);
float l9_132=packValue(l9_131);
int l9_139=int(l9_128.w*255.0);
float l9_140=packValue(l9_139);
sc_writeFragData0(vec4(packValue(l9_131),packValue(l9_131),packValue(l9_131),packValue(l9_131)));
sc_writeFragData1(vec4(l9_132,packValue(l9_131),packValue(l9_131),packValue(l9_131)));
sc_writeFragData2(vec4(l9_140,packValue(l9_139),packValue(l9_139),packValue(l9_139)));
...
#if (sc_OITMaxLayers4Plus1)
{
if ((gl_FragCoord.z-texture2D(sc_OITFrontDepthTexture,l9_143).x)<=getFrontLayerZTestEpsilon())
{
discard;
}
}
...
if (l9_148==0)
{
l9_151=texture2D(sc_OITAlpha0,l9_143);
l9_150=texture2D(sc_OITDepthLow0,l9_143);
l9_149=texture2D(sc_OITDepthHigh0,l9_143);
}
else
{
l9_151=vec4(0.0);
...
if (l9_148==1)
{
l9_154=texture2D(sc_OITAlpha1,l9_143);
l9_153=texture2D(sc_OITDepthLow1,l9_143);
l9_152=texture2D(sc_OITDepthHigh1,l9_143);
}
else
{
l9_154=l9_151;
...
if (any(notEqual(l9_152,vec4(0.0)))||any(notEqual(l9_153,vec4(0.0))))
{
int l9_155[8]=l9_144;
unpackValues(l9_152.w,l9_148,l9_155);
unpackValues(l9_152.z,l9_148,l9_155);
unpackValues(l9_152.y,l9_148,l9_155);
unpackValues(l9_152.x,l9_148,l9_155);
unpackValues(l9_153.w,l9_148,l9_155);
unpackValues(l9_153.z,l9_148,l9_155);
unpackValues(l9_153.y,l9_148,l9_155);
unpackValues(l9_153.x,l9_148,l9_155);
int l9_164[8]=l9_145;
unpackValues(l9_154.w,l9_148,l9_164);
unpackValues(l9_154.z,l9_148,l9_164);
unpackValues(l9_154.y,l9_148,l9_164);
unpackValues(l9_154.x,l9_148,l9_164);
}
l9_148++;
continue;
}
...
vec4 l9_169=texture2D(sc_OITFilteredDepthBoundsTexture,l9_143);
vec2 l9_170=l9_169.xy;
int l9_171;
#if (sc_SkinBonesCount>0)
{
l9_171=encodeDepth(((1.0-l9_169.x)*1000.0)+getDepthOrderingEpsilon(),l9_170);
}
#else
{
l9_171=0;
...
#endif
int l9_172=encodeDepth(viewSpaceDepth(),l9_170);
vec4 l9_173;
l9_173=l9_128*l9_128.w;
vec4 l9_174;
int l9_175=0;
for (int snapLoopIndex=0; snapLoopIndex==0; snapLoopIndex+=0)
{
if (l9_175<8)
{
int l9_176=l9_144[l9_175];
int l9_177=l9_172-l9_171;
bool l9_178=l9_176<l9_177;
bool l9_179;
if (l9_178)
{
l9_179=l9_144[l9_175]>0;
}
else
{
l9_179=l9_178;
...
if (l9_179)
{
vec3 l9_180=l9_173.xyz*(1.0-(float(l9_145[l9_175])/255.0));
l9_174=vec4(l9_180.x,l9_180.y,l9_180.z,l9_173.w);
}
else
{
l9_174=l9_173;
